...
`].filter(ai).join(`
`)),o=Is(o),o=To(o,t),o=Ao(o,t),a=Is(a),a=To(a,t),a=Ao(a,t),o=wo(o),a=wo(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
}`;function nm(i,e,t){let n=new Ys;const r=new de,s=new de,o=new $e,a=new jp({depthPacking:Kc}),l=new Qp,u={},h=t.maxTextureSize,c={[Mn]:bt,[bt]:Mn,[Jt]:Jt},p=new zn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new de},radius:{value:4}},vertexShader:em,fragmentShader:tm}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const g=new Lt;g.setAttribute("position",new Vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new at(g,p),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=nl;let d=this.type;this.render=function(w,A,k){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||w.length===0)return;const y=i.getRenderTarget(),T=i.getActiveCubeFace(),O=i.getActiveMipmapLevel(),W=i.state;W.setBlending(gn),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const Z=d!==rn&&this.type===rn,P=d===rn&&this.type!==rn;for(let F=0,z=w.length;F<z;F++){const q=w[F],K=q.shadow;if(K===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;r.copy(K.mapSize);const j=K.getFrameExtents();if(r.multiply(j),s.copy(K.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/j.x),r.x=s.x*j.x,K.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/j.y),r.y=s.y*j.y,K.mapSize.y=s.y)),K.map===null||Z===!0||P===!0){const re=this.type!==rn?{minFilter:yt,magFilter:yt}:{};K.map!==null&&K.map.dispose(),K.map=new Fn(r.x,r.y,re),K.map.texture.name=q.name+".shadowMap",K.camera.updateProjectionMatrix()}i.setRenderTarget(K.map),i.clear();const Q=K.getViewportCount();for(let re=0;re<Q;re++){const se=K.getViewport(re);o.set(s.x*se.x,s.y*se.y,s.x*se.z,s.y*se.w),W.viewport(o),K.updateMatrices(q,re),n=K.getFrustum(),v(A,k,K.camera,q,this.type)}K.isPointLightShadow!==!0&&this.type===rn&&S(K,k),K.needsUpdate=!1}d=this.type,f.needsUpdate=!1,i.setRenderTarget(y,T,O)};function S(w,A){const k=e.update(_);p.defines.VSM_SAMPLES!==w.blurSamples&&(p.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Fn(r.x,r.y)),p.uniforms.shadow_pass.value=w.map.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(A,null,k,p,_,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(A,null,k,m,_,null)}function x(w,A,k,y){let T=null;const O=k.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(O!==void 0)T=O;else if(T=k.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const W=T.uuid,Z=A.uuid;let P=u[W];P===void 0&&(P={},u[W]=P);let F=P[Z];F===void 0&&(F=T.clone(),P[Z]=F,A.addEventListener("dispose",C)),T=F}if(T.visible=A.visible,T.wireframe=A.wireframe,y===rn?T.side=A.shadowSide!==null?A.shadowSide:A.side:T.side=A.shadowSide!==null?A.shadowSide:c[A.side],T.alphaMap=A.alphaMap,T.alphaTest=A.alphaTest,T.map=A.map,T.clipShadows=A.clipShadows,T.clippingPlanes=A.clippingPlanes,T.clipIntersection=A.clipIntersection,T.displacementMap=A.displacementMap,T.displacementScale=A.displacementScale,T.displacementBias=A.displacementBias,T.wireframeLinewidth=A.wireframeLinewidth,T.linewidth=A.linewidth,k.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const W=i.properties.get(T);W.light=k}return T}function v(w,A,k,y,T){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&T===rn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,w.matrixWorld);const Z=e.update(w),P=w.material;if(Array.isArray(P)){const F=Z.groups;for(let z=0,q=F.length;z<q;z++){const K=F[z],j=P[K.materialIndex];if(j&&j.visible){const Q=x(w,j,y,T);w.onBeforeShadow(i,w,A,k,Z,Q,K),i.renderBufferDirect(k,null,Z,Q,w,K),w.onAfterShadow(i,w,A,k,Z,Q,K)}}}else if(P.visible){const F=x(w,P,y,T);w.onBeforeShadow(i,w,A,k,Z,F,null),i.renderBufferDirect(k,null,Z,F,w,null),w.onAfterShadow(i,w,A,k,Z,F,null)}}const W=w.children;for(let Z=0,P=W.length;Z<P;Z++)v(W[Z],A,k,y,T)}function C(w){w.target.removeEventListener("dispose",C);for(const k in u){const y=u[k],T=w.target.uuid;T in y&&(y[T].dispose(),delete y[T])}}}function im(i,e,t){const n=t.isWebGL2;function r(){let L=!1;const pe=new $e;let me=null;const Ie=new $e(0,0,0,0);return{setMask:function(Le){me!==Le&&!L&&(i.colorMask(Le,Le,Le,Le),me=Le)},setLocked:function(Le){L=Le},setClear:function(Le,Ye,Je,ct,xt){xt===!0&&(Le*=ct,Ye*=ct,Je*=ct),pe.set(Le,Ye,Je,ct),Ie.equals(pe)===!1&&(i.clearColor(Le,Ye,Je,ct),Ie.copy(pe))},reset:function(){L=!1,me=null,Ie.set(-1,0,0,0)}}}function s(){let L=!1,pe=null,me=null,Ie=null;return{setTest:function(Le){Le?De(i.DEPTH_TEST):Ee(i.DEPTH_TEST)},setMask:function(Le){pe!==Le&&!L&&(i.depthMask(Le),pe=Le)},setFunc:function(Le){if(me!==Le){switch(Le){case bc:i.depthFunc(i.NEVER);break;case Tc:i.depthFunc(i.ALWAYS);break;case Ac:i.depthFunc(i.LESS);break;case yr:i.depthFunc(i.LEQUAL);break;case wc:i.depthFunc(i.EQUAL);break;case Rc:i.depthFunc(i.GEQUAL);break;case Cc:i.depthFunc(i.GREATER);break;case Lc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=Le}},setLocked:function(Le){L=Le},setClear:function(Le){Ie!==Le&&(i.clearDepth(Le),Ie=Le)},reset:function(){L=!1,pe=null,me=null,Ie=null}}}function o(){let L=!1,pe=null,me=null,Ie=null,Le=null,Ye=null,Je=null,ct=null,xt=null;return{setTest:function(Ke){L||(Ke?De(i.STENCIL_TEST):Ee(i.STENCIL_TEST))},setMask:function(Ke){pe!==Ke&&!L&&(i.stencilMask(Ke),pe=Ke)},setFunc:function(Ke,Mt,kt){(me!==Ke||Ie!==Mt||Le!==kt)&&(i.stencilFunc(Ke,Mt,kt),me=Ke,Ie=Mt,Le=kt)},setOp:function(Ke,Mt,kt){(Ye!==Ke||Je!==Mt||ct!==kt)&&(i.stencilOp(Ke,Mt,kt),Ye=Ke,Je=Mt,ct=kt)},setLocked:function(Ke){L=Ke},setClear:function(Ke){xt!==Ke&&(i.clearStencil(Ke),xt=Ke)},reset:function(){L=!1,pe=null,me=null,Ie=null,Le=null,Ye=null,Je=null,ct=null,xt=null}}}const a=new r,l=new s,u=new o,h=new WeakMap,c=new WeakMap;let p={},m={},g=new WeakMap,_=[],f=null,d=!1,S=null,x=null,v=null,C=null,w=null,A=null,k=null,y=new We(0,0,0),T=0,O=!1,W=null,Z=null,P=null,F=null,z=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,j=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(Q)[1]),K=j>=1):Q.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),K=j>=2);let re=null,se={};const X=i.getParameter(i.SCISSOR_BOX),ne=i.getParameter(i.VIEWPORT),le=new $e().fromArray(X),Se=new $e().fromArray(ne);function ve(L,pe,me,Ie){const Le=new Uint8Array(4),Ye=i.createTexture();i.bindTexture(L,Ye),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Je=0;Je<me;Je++)n&&(L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY)?i.texImage3D(pe,0,i.RGBA,1,1,Ie,0,i.RGBA,i.UNSIGNED_BYTE,Le):i.texImage2D(pe+Je,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Le);return Ye}const Re={};Re[i.TEXTURE_2D]=ve(i.TEXTURE_2D,i.TEXTURE_2D,1),Re[i.TEXTURE_CUBE_MAP]=ve(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(Re[i.TEXTURE_2D_ARRAY]=ve(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Re[i.TEXTURE_3D]=ve(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),u.setClear(0),De(i.DEPTH_TEST),l.setFunc(yr),ge(!1),E(ha),De(i.CULL_FACE),J(gn);function De(L){p[L]!==!0&&(i.enable(L),p[L]=!0)}function Ee(L){p[L]!==!1&&(i.disable(L),p[L]=!1)}function Ce(L,pe){return m[L]!==pe?(i.bindFramebuffer(L,pe),m[L]=pe,n&&(L===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=pe),L===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=pe)),!0):!1}function R(L,pe){let me=_,Ie=!1;if(L)if(me=g.get(pe),me===void 0&&(me=[],g.set(pe,me)),L.isWebGLMultipleRenderTargets){const Le=L.texture;if(me.length!==Le.length||me[0]!==i.COLOR_ATTACHMENT0){for(let Ye=0,Je=Le.length;Ye<Je;Ye++)me[Ye]=i.COLOR_ATTACHMENT0+Ye;me.length=Le.length,Ie=!0}}else me[0]!==i.COLOR_ATTACHMENT0&&(me[0]=i.COLOR_ATTACHMENT0,Ie=!0);else me[0]!==i.BACK&&(me[0]=i.BACK,Ie=!0);Ie&&(t.isWebGL2?i.drawBuffers(me):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(me))}function oe(L){return f!==L?(i.useProgram(L),f=L,!0):!1}const Y={[Ln]:i.FUNC_ADD,[cc]:i.FUNC_SUBTRACT,[uc]:i.FUNC_REVERSE_SUBTRACT};if(n)Y[ma]=i.MIN,Y[ga]=i.MAX;else{const L=e.get("EXT_blend_minmax");L!==null&&(Y[ma]=L.MIN_EXT,Y[ga]=L.MAX_EXT)}const ae={[hc]:i.ZERO,[fc]:i.ONE,[dc]:i.SRC_COLOR,[As]:i.SRC_ALPHA,[xc]:i.SRC_ALPHA_SATURATE,[_c]:i.DST_COLOR,[mc]:i.DST_ALPHA,[pc]:i.ONE_MINUS_SRC_COLOR,[ws]:i.ONE_MINUS_SRC_ALPHA,[vc]:i.ONE_MINUS_DST_COLOR,[gc]:i.ONE_MINUS_DST_ALPHA,[Mc]:i.CONSTANT_COLOR,[Sc]:i.ONE_MINUS_CONSTANT_COLOR,[yc]:i.CONSTANT_ALPHA,[Ec]:i.ONE_MINUS_CONSTANT_ALPHA};function J(L,pe,me,Ie,Le,Ye,Je,ct,xt,Ke){if(L===gn){d===!0&&(Ee(i.BLEND),d=!1);return}if(d===!1&&(De(i.BLEND),d=!0),L!==lc){if(L!==S||Ke!==O){if((x!==Ln||w!==Ln)&&(i.blendEquation(i.FUNC_ADD),x=Ln,w=Ln),Ke)switch(L){case li:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fa:i.blendFunc(i.ONE,i.ONE);break;case da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case pa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case fa:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case pa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}v=null,C=null,A=null,k=null,y.set(0,0,0),T=0,S=L,O=Ke}return}Le=Le||pe,Ye=Ye||me,Je=Je||Ie,(pe!==x||Le!==w)&&(i.blendEquationSeparate(Y[pe],Y[Le]),x=pe,w=Le),(me!==v||Ie!==C||Ye!==A||Je!==k)&&(i.blendFuncSeparate(ae[me],ae[Ie],ae[Ye],ae[Je]),v=me,C=Ie,A=Ye,k=Je),(ct.equals(y)===!1||xt!==T)&&(i.blendColor(ct.r,ct.g,ct.b,xt),y.copy(ct),T=xt),S=L,O=!1}function be(L,pe){L.side===Jt?Ee(i.CULL_FACE):De(i.CULL_FACE);let me=L.side===bt;pe&&(me=!me),ge(me),L.blending===li&&L.transparent===!1?J(gn):J(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),l.setFunc(L.depthFunc),l.setTest(L.depthTest),l.setMask(L.depthWrite),a.setMask(L.colorWrite);const Ie=L.stencilWrite;u.setTest(Ie),Ie&&(u.setMask(L.stencilWriteMask),u.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),u.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),N(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?De(i.SAMPLE_ALPHA_TO_COVERAGE):Ee(i.SAMPLE_ALPHA_TO_COVERAGE)}function ge(L){W!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),W=L)}function E(L){L!==sc?(De(i.CULL_FACE),L!==Z&&(L===ha?i.cullFace(i.BACK):L===ac?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ee(i.CULL_FACE),Z=L}function M(L){L!==P&&(K&&i.lineWidth(L),P=L)}function N(L,pe,me){L?(De(i.POLYGON_OFFSET_FILL),(F!==pe||z!==me)&&(i.polygonOffset(pe,me),F=pe,z=me)):Ee(i.POLYGON_OFFSET_FILL)}function ie(L){L?De(i.SCISSOR_TEST):Ee(i.SCISSOR_TEST)}function ee(L){L===void 0&&(L=i.TEXTURE0+q-1),re!==L&&(i.activeTexture(L),re=L)}function te(L,pe,me){me===void 0&&(re===null?me=i.TEXTURE0+q-1:me=re);let Ie=se[me];Ie===void 0&&(Ie={type:void 0,texture:void 0},se[me]=Ie),(Ie.type!==L||Ie.texture!==pe)&&(re!==me&&(i.activeTexture(me),re=me),i.bindTexture(L,pe||Re[L]),Ie.type=L,Ie.texture=pe)}function ye(){const L=se[re];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function fe(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function U(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function $(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ce(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function H(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _e(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ae(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ue(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function we(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Me(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Fe(L){le.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),le.copy(L))}function Xe(L){Se.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Se.copy(L))}function et(L,pe){let me=c.get(pe);me===void 0&&(me=new WeakMap,c.set(pe,me));let Ie=me.get(L);Ie===void 0&&(Ie=i.getUniformBlockIndex(pe,L.name),me.set(L,Ie))}function He(L,pe){const Ie=c.get(pe).get(L);h.get(pe)!==Ie&&(i.uniformBlockBinding(pe,Ie,L.__bindingPointIndex),h.set(pe,Ie))}function ue(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},re=null,se={},m={},g=new WeakMap,_=[],f=null,d=!1,S=null,x=null,v=null,C=null,w=null,A=null,k=null,y=new We(0,0,0),T=0,O=!1,W=null,Z=null,P=null,F=null,z=null,le.set(0,0,i.canvas.width,i.canvas.height),Se.set(0,0,i.canvas.width,i.canvas.height),a.reset(),l.reset(),u.reset()}return{buffers:{color:a,depth:l,stencil:u},enable:De,disable:Ee,bindFramebuffer:Ce,drawBuffers:R,useProgram:oe,setBlending:J,setMaterial:be,setFlipSided:ge,setCullFace:E,setLineWidth:M,setPolygonOffset:N,setScissorTest:ie,activeTexture:ee,bindTexture:te,unbindTexture:ye,compressedTexImage2D:fe,compressedTexImage3D:U,texImage2D:we,texImage3D:Me,updateUBOMapping:et,uniformBlockBinding:He,texStorage2D:Ae,texStorage3D:Ue,texSubImage2D:$,texSubImage3D:ce,compressedTexSubImage2D:H,compressedTexSubImage3D:_e,scissor:Fe,viewport:Xe,reset:ue}}function rm(i,e,t,n,r,s,o){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new WeakMap;let c;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,M){return m?new OffscreenCanvas(E,M):wr("canvas")}function _(E,M,N,ie){let ee=1;if((E.width>ie||E.height>ie)&&(ee=ie/Math.max(E.width,E.height)),ee<1||M===!0)if(typeof HTMLImageElement!="undefined"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&E instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&E instanceof ImageBitmap){const te=M?Us:Math.floor,ye=te(ee*E.width),fe=te(ee*E.height);c===void 0&&(c=g(ye,fe));const U=N?g(ye,fe):c;return U.width=ye,U.height=fe,U.getContext("2d").drawImage(E,0,0,ye,fe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+ye+"x"+fe+")."),U}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function f(E){return qa(E.width)&&qa(E.height)}function d(E){return a?!1:E.wrapS!==Gt||E.wrapT!==Gt||E.minFilter!==yt&&E.minFilter!==Ut}function S(E,M){return E.generateMipmaps&&M&&E.minFilter!==yt&&E.minFilter!==Ut}function x(E){i.generateMipmap(E)}function v(E,M,N,ie,ee=!1){if(a===!1)return M;if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let te=M;if(M===i.RED&&(N===i.FLOAT&&(te=i.R32F),N===i.HALF_FLOAT&&(te=i.R16F),N===i.UNSIGNED_BYTE&&(te=i.R8)),M===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(te=i.R8UI),N===i.UNSIGNED_SHORT&&(te=i.R16UI),N===i.UNSIGNED_INT&&(te=i.R32UI),N===i.BYTE&&(te=i.R8I),N===i.SHORT&&(te=i.R16I),N===i.INT&&(te=i.R32I)),M===i.RG&&(N===i.FLOAT&&(te=i.RG32F),N===i.HALF_FLOAT&&(te=i.RG16F),N===i.UNSIGNED_BYTE&&(te=i.RG8)),M===i.RGBA){const ye=ee?Er:qe.getTransfer(ie);N===i.FLOAT&&(te=i.RGBA32F),N===i.HALF_FLOAT&&(te=i.RGBA16F),N===i.UNSIGNED_BYTE&&(te=ye===Ze?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(te=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(te=i.RGB5_A1)}return(te===i.R16F||te===i.R32F||te===i.RG16F||te===i.RG32F||te===i.RGBA16F||te===i.RGBA32F)&&e.get("EXT_color_buffer_float"),te}function C(E,M,N){return S(E,N)===!0||E.isFramebufferTexture&&E.minFilter!==yt&&E.minFilter!==Ut?Math.log2(Math.max(M.width,M.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?M.mipmaps.length:1}function w(E){return E===yt||E===_a||E===Hr?i.NEAREST:i.LINEAR}function A(E){const M=E.target;M.removeEventListener("dispose",A),y(M),M.isVideoTexture&&h.delete(M)}function k(E){const M=E.target;M.removeEventListener("dispose",k),O(M)}function y(E){const M=n.get(E);if(M.__webglInit===void 0)return;const N=E.source,ie=p.get(N);if(ie){const ee=ie[M.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&T(E),Object.keys(ie).length===0&&p.delete(N)}n.remove(E)}function T(E){const M=n.get(E);i.deleteTexture(M.__webglTexture);const N=E.source,ie=p.get(N);delete ie[M.__cacheKey],o.memory.textures--}function O(E){const M=E.texture,N=n.get(E),ie=n.get(M);if(ie.__webglTexture!==void 0&&(i.deleteTexture(ie.__webglTexture),o.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(N.__webglFramebuffer[ee]))for(let te=0;te<N.__webglFramebuffer[ee].length;te++)i.deleteFramebuffer(N.__webglFramebuffer[ee][te]);else i.deleteFramebuffer(N.__webglFramebuffer[ee]);N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer[ee])}else{if(Array.isArray(N.__webglFramebuffer))for(let ee=0;ee<N.__webglFramebuffer.length;ee++)i.deleteFramebuffer(N.__webglFramebuffer[ee]);else i.deleteFramebuffer(N.__webglFramebuffer);if(N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer),N.__webglMultisampledFramebuffer&&i.deleteFramebuffer(N.__webglMultisampledFramebuffer),N.__webglColorRenderbuffer)for(let ee=0;ee<N.__webglColorRenderbuffer.length;ee++)N.__webglColorRenderbuffer[ee]&&i.deleteRenderbuffer(N.__webglColorRenderbuffer[ee]);N.__webglDepthRenderbuffer&&i.deleteRenderbuffer(N.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let ee=0,te=M.length;ee<te;ee++){const ye=n.get(M[ee]);ye.__webglTexture&&(i.deleteTexture(ye.__webglTexture),o.memory.textures--),n.remove(M[ee])}n.remove(M),n.remove(E)}let W=0;function Z(){W=0}function P(){const E=W;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),W+=1,E}function F(E){const M=[];return M.push(E.wrapS),M.push(E.wrapT),M.push(E.wrapR||0),M.push(E.magFilter),M.push(E.minFilter),M.push(E.anisotropy),M.push(E.internalFormat),M.push(E.format),M.push(E.type),M.push(E.generateMipmaps),M.push(E.premultiplyAlpha),M.push(E.flipY),M.push(E.unpackAlignment),M.push(E.colorSpace),M.join()}function z(E,M){const N=n.get(E);if(E.isVideoTexture&&be(E),E.isRenderTargetTexture===!1&&E.version>0&&N.__version!==E.version){const ie=E.image;if(ie===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{le(N,E,M);return}}t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+M)}function q(E,M){const N=n.get(E);if(E.version>0&&N.__version!==E.version){le(N,E,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+M)}function K(E,M){const N=n.get(E);if(E.version>0&&N.__version!==E.version){le(N,E,M);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+M)}function j(E,M){const N=n.get(E);if(E.version>0&&N.__version!==E.version){Se(N,E,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+M)}const Q={[Ii]:i.REPEAT,[Gt]:i.CLAMP_TO_EDGE,[Ls]:i.MIRRORED_REPEAT},re={[yt]:i.NEAREST,[_a]:i.NEAREST_MIPMAP_NEAREST,[Hr]:i.NEAREST_MIPMAP_LINEAR,[Ut]:i.LINEAR,[zc]:i.LINEAR_MIPMAP_NEAREST,[Ni]:i.LINEAR_MIPMAP_LINEAR},se={[$c]:i.NEVER,[iu]:i.ALWAYS,[jc]:i.LESS,[dl]:i.LEQUAL,[Qc]:i.EQUAL,[nu]:i.GEQUAL,[eu]:i.GREATER,[tu]:i.NOTEQUAL};function X(E,M,N){if(N?(i.texParameteri(E,i.TEXTURE_WRAP_S,Q[M.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,Q[M.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,Q[M.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,re[M.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,re[M.minFilter])):(i.texParameteri(E,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(E,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(M.wrapS!==Gt||M.wrapT!==Gt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(E,i.TEXTURE_MAG_FILTER,w(M.magFilter)),i.texParameteri(E,i.TEXTURE_MIN_FILTER,w(M.minFilter)),M.minFilter!==yt&&M.minFilter!==Ut&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),M.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,se[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ie=e.get("EXT_texture_filter_anisotropic");if(M.magFilter===yt||M.minFilter!==Hr&&M.minFilter!==Ni||M.type===mn&&e.has("OES_texture_float_linear")===!1||a===!1&&M.type===Oi&&e.has("OES_texture_half_float_linear")===!1)return;(M.anisotropy>1||n.get(M).__currentAnisotropy)&&(i.texParameterf(E,ie.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy)}}function ne(E,M){let N=!1;E.__webglInit===void 0&&(E.__webglInit=!0,M.addEventListener("dispose",A));const ie=M.source;let ee=p.get(ie);ee===void 0&&(ee={},p.set(ie,ee));const te=F(M);if(te!==E.__cacheKey){ee[te]===void 0&&(ee[te]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),ee[te].usedTimes++;const ye=ee[E.__cacheKey];ye!==void 0&&(ee[E.__cacheKey].usedTimes--,ye.usedTimes===0&&T(M)),E.__cacheKey=te,E.__webglTexture=ee[te].texture}return N}function le(E,M,N){let ie=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(ie=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(ie=i.TEXTURE_3D);const ee=ne(E,M),te=M.source;t.bindTexture(ie,E.__webglTexture,i.TEXTURE0+N);const ye=n.get(te);if(te.version!==ye.__version||ee===!0){t.activeTexture(i.TEXTURE0+N);const fe=qe.getPrimaries(qe.workingColorSpace),U=M.colorSpace===It?null:qe.getPrimaries(M.colorSpace),$=M.colorSpace===It||fe===U?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,$);const ce=d(M)&&f(M.image)===!1;let H=_(M.image,ce,!1,r.maxTextureSize);H=ge(M,H);const _e=f(H)||a,Ae=s.convert(M.format,M.colorSpace);let Ue=s.convert(M.type),we=v(M.internalFormat,Ae,Ue,M.colorSpace,M.isVideoTexture);X(ie,M,_e);let Me;const Fe=M.mipmaps,Xe=a&&M.isVideoTexture!==!0&&we!==ul,et=ye.__version===void 0||ee===!0,He=C(M,H,_e);if(M.isDepthTexture)we=i.DEPTH_COMPONENT,a?M.type===mn?we=i.DEPTH_COMPONENT32F:M.type===pn?we=i.DEPTH_COMPONENT24:M.type===Un?we=i.DEPTH24_STENCIL8:we=i.DEPTH_COMPONENT16:M.type===mn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),M.format===In&&we===i.DEPTH_COMPONENT&&M.type!==Xs&&M.type!==pn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),M.type=pn,Ue=s.convert(M.type)),M.format===fi&&we===i.DEPTH_COMPONENT&&(we=i.DEPTH_STENCIL,M.type!==Un&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),M.type=Un,Ue=s.convert(M.type))),et&&(Xe?t.texStorage2D(i.TEXTURE_2D,1,we,H.width,H.height):t.texImage2D(i.TEXTURE_2D,0,we,H.width,H.height,0,Ae,Ue,null));else if(M.isDataTexture)if(Fe.length>0&&_e){Xe&&et&&t.texStorage2D(i.TEXTURE_2D,He,we,Fe[0].width,Fe[0].height);for(let ue=0,L=Fe.length;ue<L;ue++)Me=Fe[ue],Xe?t.texSubImage2D(i.TEXTURE_2D,ue,0,0,Me.width,Me.height,Ae,Ue,Me.data):t.texImage2D(i.TEXTURE_2D,ue,we,Me.width,Me.height,0,Ae,Ue,Me.data);M.generateMipmaps=!1}else Xe?(et&&t.texStorage2D(i.TEXTURE_2D,He,we,H.width,H.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,H.width,H.height,Ae,Ue,H.data)):t.texImage2D(i.TEXTURE_2D,0,we,H.width,H.height,0,Ae,Ue,H.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Xe&&et&&t.texStorage3D(i.TEXTURE_2D_ARRAY,He,we,Fe[0].width,Fe[0].height,H.depth);for(let ue=0,L=Fe.length;ue<L;ue++)Me=Fe[ue],M.format!==Ht?Ae!==null?Xe?t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ue,0,0,0,Me.width,Me.height,H.depth,Ae,Me.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ue,we,Me.width,Me.height,H.depth,0,Me.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Xe?t.texSubImage3D(i.TEXTURE_2D_ARRAY,ue,0,0,0,Me.width,Me.height,H.depth,Ae,Ue,Me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ue,we,Me.width,Me.height,H.depth,0,Ae,Ue,Me.data)}else{Xe&&et&&t.texStorage2D(i.TEXTURE_2D,He,we,Fe[0].width,Fe[0].height);for(let ue=0,L=Fe.length;ue<L;ue++)Me=Fe[ue],M.format!==Ht?Ae!==null?Xe?t.compressedTexSubImage2D(i.TEXTURE_2D,ue,0,0,Me.width,Me.height,Ae,Me.data):t.compressedTexImage2D(i.TEXTURE_2D,ue,we,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Xe?t.texSubImage2D(i.TEXTURE_2D,ue,0,0,Me.width,Me.height,Ae,Ue,Me.data):t.texImage2D(i.TEXTURE_2D,ue,we,Me.width,Me.height,0,Ae,Ue,Me.data)}else if(M.isDataArrayTexture)Xe?(et&&t.texStorage3D(i.TEXTURE_2D_ARRAY,He,we,H.width,H.height,H.depth),t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,H.width,H.height,H.depth,Ae,Ue,H.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,we,H.width,H.height,H.depth,0,Ae,Ue,H.data);else if(M.isData3DTexture)Xe?(et&&t.texStorage3D(i.TEXTURE_3D,He,we,H.width,H.height,H.depth),t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,H.width,H.height,H.depth,Ae,Ue,H.data)):t.texImage3D(i.TEXTURE_3D,0,we,H.width,H.height,H.depth,0,Ae,Ue,H.data);else if(M.isFramebufferTexture){if(et)if(Xe)t.texStorage2D(i.TEXTURE_2D,He,we,H.width,H.height);else{let ue=H.width,L=H.height;for(let pe=0;pe<He;pe++)t.texImage2D(i.TEXTURE_2D,pe,we,ue,L,0,Ae,Ue,null),ue>>=1,L>>=1}}else if(Fe.length>0&&_e){Xe&&et&&t.texStorage2D(i.TEXTURE_2D,He,we,Fe[0].width,Fe[0].height);for(let ue=0,L=Fe.length;ue<L;ue++)Me=Fe[ue],Xe?t.texSubImage2D(i.TEXTURE_2D,ue,0,0,Ae,Ue,Me):t.texImage2D(i.TEXTURE_2D,ue,we,Ae,Ue,Me);M.generateMipmaps=!1}else Xe?(et&&t.texStorage2D(i.TEXTURE_2D,He,we,H.width,H.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ae,Ue,H)):t.texImage2D(i.TEXTURE_2D,0,we,Ae,Ue,H);S(M,_e)&&x(ie),ye.__version=te.version,M.onUpdate&&M.onUpdate(M)}E.__version=M.version}function Se(E,M,N){if(M.image.length!==6)return;const ie=ne(E,M),ee=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+N);const te=n.get(ee);if(ee.version!==te.__version||ie===!0){t.activeTexture(i.TEXTURE0+N);const ye=qe.getPrimaries(qe.workingColorSpace),fe=M.colorSpace===It?null:qe.getPrimaries(M.colorSpace),U=M.colorSpace===It||ye===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,U);const $=M.isCompressedTexture||M.image[0].isCompressedTexture,ce=M.image[0]&&M.image[0].isDataTexture,H=[];for(let ue=0;ue<6;ue++)!$&&!ce?H[ue]=_(M.image[ue],!1,!0,r.maxCubemapSize):H[ue]=ce?M.image[ue].image:M.image[ue],H[ue]=ge(M,H[ue]);const _e=H[0],Ae=f(_e)||a,Ue=s.convert(M.format,M.colorSpace),we=s.convert(M.type),Me=v(M.internalFormat,Ue,we,M.colorSpace),Fe=a&&M.isVideoTexture!==!0,Xe=te.__version===void 0||ie===!0;let et=C(M,_e,Ae);X(i.TEXTURE_CUBE_MAP,M,Ae);let He;if($){Fe&&Xe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,et,Me,_e.width,_e.height);for(let ue=0;ue<6;ue++){He=H[ue].mipmaps;for(let L=0;L<He.length;L++){const pe=He[L];M.format!==Ht?Ue!==null?Fe?t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L,0,0,pe.width,pe.height,Ue,pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L,Me,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Fe?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L,0,0,pe.width,pe.height,Ue,we,pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L,Me,pe.width,pe.height,0,Ue,we,pe.data)}}}else{He=M.mipmaps,Fe&&Xe&&(He.length>0&&et++,t.texStorage2D(i.TEXTURE_CUBE_MAP,et,Me,H[0].width,H[0].height));for(let ue=0;ue<6;ue++)if(ce){Fe?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,H[ue].width,H[ue].height,Ue,we,H[ue].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,Me,H[ue].width,H[ue].height,0,Ue,we,H[ue].data);for(let L=0;L<He.length;L++){const me=He[L].image[ue].image;Fe?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L+1,0,0,me.width,me.height,Ue,we,me.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L+1,Me,me.width,me.height,0,Ue,we,me.data)}}else{Fe?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,0,0,Ue,we,H[ue]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,Me,Ue,we,H[ue]);for(let L=0;L<He.length;L++){const pe=He[L];Fe?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L+1,0,0,Ue,we,pe.image[ue]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,L+1,Me,Ue,we,pe.image[ue])}}}S(M,Ae)&&x(i.TEXTURE_CUBE_MAP),te.__version=ee.version,M.onUpdate&&M.onUpdate(M)}E.__version=M.version}function ve(E,M,N,ie,ee,te){const ye=s.convert(N.format,N.colorSpace),fe=s.convert(N.type),U=v(N.internalFormat,ye,fe,N.colorSpace);if(!n.get(M).__hasExternalTextures){const ce=Math.max(1,M.width>>te),H=Math.max(1,M.height>>te);ee===i.TEXTURE_3D||ee===i.TEXTURE_2D_ARRAY?t.texImage3D(ee,te,U,ce,H,M.depth,0,ye,fe,null):t.texImage2D(ee,te,U,ce,H,0,ye,fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),J(M)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ie,ee,n.get(N).__webglTexture,0,ae(M)):(ee===i.TEXTURE_2D||ee>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ie,ee,n.get(N).__webglTexture,te),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Re(E,M,N){if(i.bindRenderbuffer(i.RENDERBUFFER,E),M.depthBuffer&&!M.stencilBuffer){let ie=a===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(N||J(M)){const ee=M.depthTexture;ee&&ee.isDepthTexture&&(ee.type===mn?ie=i.DEPTH_COMPONENT32F:ee.type===pn&&(ie=i.DEPTH_COMPONENT24));const te=ae(M);J(M)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,te,ie,M.width,M.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,te,ie,M.width,M.height)}else i.renderbufferStorage(i.RENDERBUFFER,ie,M.width,M.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,E)}else if(M.depthBuffer&&M.stencilBuffer){const ie=ae(M);N&&J(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ie,i.DEPTH24_STENCIL8,M.width,M.height):J(M)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ie,i.DEPTH24_STENCIL8,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,E)}else{const ie=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let ee=0;ee<ie.length;ee++){const te=ie[ee],ye=s.convert(te.format,te.colorSpace),fe=s.convert(te.type),U=v(te.internalFormat,ye,fe,te.colorSpace),$=ae(M);N&&J(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,$,U,M.width,M.height):J(M)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,$,U,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,U,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function De(E,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),z(M.depthTexture,0);const ie=n.get(M.depthTexture).__webglTexture,ee=ae(M);if(M.depthTexture.format===In)J(M)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ie,0,ee):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ie,0);else if(M.depthTexture.format===fi)J(M)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ie,0,ee):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function Ee(E){const M=n.get(E),N=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!M.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");De(M.__webglFramebuffer,E)}else if(N){M.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[ie]),M.__webglDepthbuffer[ie]=i.createRenderbuffer(),Re(M.__webglDepthbuffer[ie],E,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=i.createRenderbuffer(),Re(M.__webglDepthbuffer,E,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ce(E,M,N){const ie=n.get(E);M!==void 0&&ve(ie.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&Ee(E)}function R(E){const M=E.texture,N=n.get(E),ie=n.get(M);E.addEventListener("dispose",k),E.isWebGLMultipleRenderTargets!==!0&&(ie.__webglTexture===void 0&&(ie.__webglTexture=i.createTexture()),ie.__version=M.version,o.memory.textures++);const ee=E.isWebGLCubeRenderTarget===!0,te=E.isWebGLMultipleRenderTargets===!0,ye=f(E)||a;if(ee){N.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(a&&M.mipmaps&&M.mipmaps.length>0){N.__webglFramebuffer[fe]=[];for(let U=0;U<M.mipmaps.length;U++)N.__webglFramebuffer[fe][U]=i.createFramebuffer()}else N.__webglFramebuffer[fe]=i.createFramebuffer()}else{if(a&&M.mipmaps&&M.mipmaps.length>0){N.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)N.__webglFramebuffer[fe]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(te)if(r.drawBuffers){const fe=E.texture;for(let U=0,$=fe.length;U<$;U++){const ce=n.get(fe[U]);ce.__webglTexture===void 0&&(ce.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&E.samples>0&&J(E)===!1){const fe=te?M:[M];N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let U=0;U<fe.length;U++){const $=fe[U];N.__webglColorRenderbuffer[U]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[U]);const ce=s.convert($.format,$.colorSpace),H=s.convert($.type),_e=v($.internalFormat,ce,H,$.colorSpace,E.isXRRenderTarget===!0),Ae=ae(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ae,_e,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+U,i.RENDERBUFFER,N.__webglColorRenderbuffer[U])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Re(N.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,ie.__webglTexture),X(i.TEXTURE_CUBE_MAP,M,ye);for(let fe=0;fe<6;fe++)if(a&&M.mipmaps&&M.mipmaps.length>0)for(let U=0;U<M.mipmaps.length;U++)ve(N.__webglFramebuffer[fe][U],E,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U);else ve(N.__webglFramebuffer[fe],E,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);S(M,ye)&&x(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(te){const fe=E.texture;for(let U=0,$=fe.length;U<$;U++){const ce=fe[U],H=n.get(ce);t.bindTexture(i.TEXTURE_2D,H.__webglTexture),X(i.TEXTURE_2D,ce,ye),ve(N.__webglFramebuffer,E,ce,i.COLOR_ATTACHMENT0+U,i.TEXTURE_2D,0),S(ce,ye)&&x(i.TEXTURE_2D)}t.unbindTexture()}else{let fe=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(a?fe=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(fe,ie.__webglTexture),X(fe,M,ye),a&&M.mipmaps&&M.mipmaps.length>0)for(let U=0;U<M.mipmaps.length;U++)ve(N.__webglFramebuffer[U],E,M,i.COLOR_ATTACHMENT0,fe,U);else ve(N.__webglFramebuffer,E,M,i.COLOR_ATTACHMENT0,fe,0);S(M,ye)&&x(fe),t.unbindTexture()}E.depthBuffer&&Ee(E)}function oe(E){const M=f(E)||a,N=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let ie=0,ee=N.length;ie<ee;ie++){const te=N[ie];if(S(te,M)){const ye=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,fe=n.get(te).__webglTexture;t.bindTexture(ye,fe),x(ye),t.unbindTexture()}}}function Y(E){if(a&&E.samples>0&&J(E)===!1){const M=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],N=E.width,ie=E.height;let ee=i.COLOR_BUFFER_BIT;const te=[],ye=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=n.get(E),U=E.isWebGLMultipleRenderTargets===!0;if(U)for(let $=0;$<M.length;$++)t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let $=0;$<M.length;$++){te.push(i.COLOR_ATTACHMENT0+$),E.depthBuffer&&te.push(ye);const ce=fe.__ignoreDepthValues!==void 0?fe.__ignoreDepthValues:!1;if(ce===!1&&(E.depthBuffer&&(ee|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&(ee|=i.STENCIL_BUFFER_BIT)),U&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,fe.__webglColorRenderbuffer[$]),ce===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[ye]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[ye])),U){const H=n.get(M[$]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,H,0)}i.blitFramebuffer(0,0,N,ie,0,0,N,ie,ee,i.NEAREST),u&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,te)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),U)for(let $=0;$<M.length;$++){t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,fe.__webglColorRenderbuffer[$]);const ce=n.get(M[$]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.TEXTURE_2D,ce,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}}function ae(E){return Math.min(r.maxSamples,E.samples)}function J(E){const M=n.get(E);return a&&E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function be(E){const M=o.render.frame;h.get(E)!==M&&(h.set(E,M),E.update())}function ge(E,M){const N=E.colorSpace,ie=E.format,ee=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||E.format===Ps||N!==ln&&N!==It&&(qe.getTransfer(N)===Ze?a===!1?e.has("EXT_sRGB")===!0&&ie===Ht?(E.format=Ps,E.minFilter=Ut,E.generateMipmaps=!1):M=ml.sRGBToLinear(M):(ie!==Ht||ee!==vn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),M}this.allocateTextureUnit=P,this.resetTextureUnits=Z,this.setTexture2D=z,this.setTexture2DArray=q,this.setTexture3D=K,this.setTextureCube=j,this.rebindTextures=Ce,this.setupRenderTarget=R,this.updateRenderTargetMipmap=oe,this.updateMultisampleRenderTarget=Y,this.setupDepthRenderbuffer=Ee,this.setupFrameBufferTexture=ve,this.useMultisampledRTT=J}function sm(i,e,t){const n=t.isWebGL2;function r(s,o=It){let a;const l=qe.getTransfer(o);if(s===vn)return i.UNSIGNED_BYTE;if(s===sl)return i.UNSIGNED_SHORT_4_4_4_4;if(s===al)return i.UNSIGNED_SHORT_5_5_5_1;if(s===Gc)return i.BYTE;if(s===Hc)return i.SHORT;if(s===Xs)return i.UNSIGNED_SHORT;if(s===rl)return i.INT;if(s===pn)return i.UNSIGNED_INT;if(s===mn)return i.FLOAT;if(s===Oi)return n?i.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Vc)return i.ALPHA;if(s===Ht)return i.RGBA;if(s===kc)return i.LUMINANCE;if(s===Wc)return i.LUMINANCE_ALPHA;if(s===In)return i.DEPTH_COMPONENT;if(s===fi)return i.DEPTH_STENCIL;if(s===Ps)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Xc)return i.RED;if(s===ol)return i.RED_INTEGER;if(s===qc)return i.RG;if(s===ll)return i.RG_INTEGER;if(s===cl)return i.RGBA_INTEGER;if(s===Vr||s===kr||s===Wr||s===Xr)if(l===Ze)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===Vr)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===kr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Wr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Xr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===Vr)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===kr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Wr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Xr)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===va||s===xa||s===Ma||s===Sa)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===va)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===xa)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Ma)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Sa)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ul)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===ya||s===Ea)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===ya)return l===Ze?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Ea)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ba||s===Ta||s===Aa||s===wa||s===Ra||s===Ca||s===La||s===Pa||s===Da||s===Ua||s===Ia||s===Na||s===Oa||s===Fa)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===ba)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ta)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Aa)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===wa)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Ra)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ca)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===La)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Pa)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Da)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Ua)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Ia)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Na)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Oa)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Fa)return l===Ze?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===qr||s===Ba||s===za)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===qr)return l===Ze?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Ba)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===za)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Yc||s===Ga||s===Ha||s===Va)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===qr)return a.COMPRESSED_RED_RGTC1_EXT;if(s===Ga)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ha)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Va)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Un?n?i.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class am extends Ct{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Dn extends ft{constructor(){super(),this.isGroup=!0,this.type="Group"}}const om={type:"move"};class _s{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Dn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Dn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new D,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new D),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Dn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new D,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new D),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const _ of e.hand.values()){const f=t.getJointPose(_,n),d=this._getHandJoint(u,_);f!==null&&(d.matrix.fromArray(f.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=f.radius),d.visible=f!==null}const h=u.joints["index-finger-tip"],c=u.joints["thumb-tip"],p=h.position.distanceTo(c.position),m=.02,g=.005;u.inputState.pinching&&p>m+g?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&p<=m-g&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(om)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Dn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}class lm extends mi{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,h=null,c=null,p=null,m=null,g=null;const _=t.getContextAttributes();let f=null,d=null;const S=[],x=[],v=new de;let C=null;const w=new Ct;w.layers.enable(1),w.viewport=new $e;const A=new Ct;A.layers.enable(2),A.viewport=new $e;const k=[w,A],y=new am;y.layers.enable(1),y.layers.enable(2);let T=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let ne=S[X];return ne===void 0&&(ne=new _s,S[X]=ne),ne.getTargetRaySpace()},this.getControllerGrip=function(X){let ne=S[X];return ne===void 0&&(ne=new _s,S[X]=ne),ne.getGripSpace()},this.getHand=function(X){let ne=S[X];return ne===void 0&&(ne=new _s,S[X]=ne),ne.getHandSpace()};function W(X){const ne=x.indexOf(X.inputSource);if(ne===-1)return;const le=S[ne];le!==void 0&&(le.update(X.inputSource,X.frame,u||o),le.dispatchEvent({type:X.type,data:X.inputSource}))}function Z(){r.removeEventListener("select",W),r.removeEventListener("selectstart",W),r.removeEventListener("selectend",W),r.removeEventListener("squeeze",W),r.removeEventListener("squeezestart",W),r.removeEventListener("squeezeend",W),r.removeEventListener("end",Z),r.removeEventListener("inputsourceschange",P);for(let X=0;X<S.length;X++){const ne=x[X];ne!==null&&(x[X]=null,S[X].disconnect(ne))}T=null,O=null,e.setRenderTarget(f),m=null,p=null,c=null,r=null,d=null,se.stop(),n.isPresenting=!1,e.setPixelRatio(C),e.setSize(v.width,v.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(X){u=X},this.getBaseLayer=function(){return p!==null?p:m},this.getBinding=function(){return c},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(f=e.getRenderTarget(),r.addEventListener("select",W),r.addEventListener("selectstart",W),r.addEventListener("selectend",W),r.addEventListener("squeeze",W),r.addEventListener("squeezestart",W),r.addEventListener("squeezeend",W),r.addEventListener("end",Z),r.addEventListener("inputsourceschange",P),_.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(v),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const ne={antialias:r.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,ne),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),d=new Fn(m.framebufferWidth,m.framebufferHeight,{format:Ht,type:vn,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let ne=null,le=null,Se=null;_.depth&&(Se=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ne=_.stencil?fi:In,le=_.stencil?Un:pn);const ve={colorFormat:t.RGBA8,depthFormat:Se,scaleFactor:s};c=new XRWebGLBinding(r,t),p=c.createProjectionLayer(ve),r.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),d=new Fn(p.textureWidth,p.textureHeight,{format:Ht,type:vn,depthTexture:new Rl(p.textureWidth,p.textureHeight,le,void 0,void 0,void 0,void 0,void 0,void 0,ne),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0});const Re=e.properties.get(d);Re.__ignoreDepthValues=p.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),se.setContext(r),se.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function P(X){for(let ne=0;ne<X.removed.length;ne++){const le=X.removed[ne],Se=x.indexOf(le);Se>=0&&(x[Se]=null,S[Se].disconnect(le))}for(let ne=0;ne<X.added.length;ne++){const le=X.added[ne];let Se=x.indexOf(le);if(Se===-1){for(let Re=0;Re<S.length;Re++)if(Re>=x.length){x.push(le),Se=Re;break}else if(x[Re]===null){x[Re]=le,Se=Re;break}if(Se===-1)break}const ve=S[Se];ve&&ve.connect(le)}}const F=new D,z=new D;function q(X,ne,le){F.setFromMatrixPosition(ne.matrixWorld),z.setFromMatrixPosition(le.matrixWorld);const Se=F.distanceTo(z),ve=ne.projectionMatrix.elements,Re=le.projectionMatrix.elements,De=ve[14]/(ve[10]-1),Ee=ve[14]/(ve[10]+1),Ce=(ve[9]+1)/ve[5],R=(ve[9]-1)/ve[5],oe=(ve[8]-1)/ve[0],Y=(Re[8]+1)/Re[0],ae=De*oe,J=De*Y,be=Se/(-oe+Y),ge=be*-oe;ne.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(ge),X.translateZ(be),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert();const E=De+be,M=Ee+be,N=ae-ge,ie=J+(Se-ge),ee=Ce*Ee/M*E,te=R*Ee/M*E;X.projectionMatrix.makePerspective(N,ie,ee,te,E,M),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}function K(X,ne){ne===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(ne.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;y.near=A.near=w.near=X.near,y.far=A.far=w.far=X.far,(T!==y.near||O!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),T=y.near,O=y.far);const ne=X.parent,le=y.cameras;K(y,ne);for(let Se=0;Se<le.length;Se++)K(le[Se],ne);le.length===2?q(y,w,A):y.projectionMatrix.copy(w.projectionMatrix),j(X,y,ne)};function j(X,ne,le){le===null?X.matrix.copy(ne.matrixWorld):(X.matrix.copy(le.matrixWorld),X.matrix.invert(),X.matrix.multiply(ne.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(ne.projectionMatrix),X.projectionMatrixInverse.copy(ne.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Ds*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(p===null&&m===null))return l},this.setFoveation=function(X){l=X,p!==null&&(p.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)};let Q=null;function re(X,ne){if(h=ne.getViewerPose(u||o),g=ne,h!==null){const le=h.views;m!==null&&(e.setRenderTargetFramebuffer(d,m.framebuffer),e.setRenderTarget(d));let Se=!1;le.length!==y.cameras.length&&(y.cameras.length=0,Se=!0);for(let ve=0;ve<le.length;ve++){const Re=le[ve];let De=null;if(m!==null)De=m.getViewport(Re);else{const Ce=c.getViewSubImage(p,Re);De=Ce.viewport,ve===0&&(e.setRenderTargetTextures(d,Ce.colorTexture,p.ignoreDepthValues?void 0:Ce.depthStencilTexture),e.setRenderTarget(d))}let Ee=k[ve];Ee===void 0&&(Ee=new Ct,Ee.layers.enable(ve),Ee.viewport=new $e,k[ve]=Ee),Ee.matrix.fromArray(Re.transform.matrix),Ee.matrix.decompose(Ee.position,Ee.quaternion,Ee.scale),Ee.projectionMatrix.fromArray(Re.projectionMatrix),Ee.projectionMatrixInverse.copy(Ee.projectionMatrix).invert(),Ee.viewport.set(De.x,De.y,De.width,De.height),ve===0&&(y.matrix.copy(Ee.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),Se===!0&&y.cameras.push(Ee)}}for(let le=0;le<S.length;le++){const Se=x[le],ve=S[le];Se!==null&&ve!==void 0&&ve.update(Se,ne,u||o)}Q&&Q(X,ne),ne.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ne}),g=null}const se=new Al;se.setAnimationLoop(re),this.setAnimationLoop=function(X){Q=X},this.dispose=function(){}}}function cm(i,e){function t(f,d){f.matrixAutoUpdate===!0&&f.updateMatrix(),d.value.copy(f.matrix)}function n(f,d){d.color.getRGB(f.fogColor.value,El(i)),d.isFog?(f.fogNear.value=d.near,f.fogFar.value=d.far):d.isFogExp2&&(f.fogDensity.value=d.density)}function r(f,d,S,x,v){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(f,d):d.isMeshToonMaterial?(s(f,d),c(f,d)):d.isMeshPhongMaterial?(s(f,d),h(f,d)):d.isMeshStandardMaterial?(s(f,d),p(f,d),d.isMeshPhysicalMaterial&&m(f,d,v)):d.isMeshMatcapMaterial?(s(f,d),g(f,d)):d.isMeshDepthMaterial?s(f,d):d.isMeshDistanceMaterial?(s(f,d),_(f,d)):d.isMeshNormalMaterial?s(f,d):d.isLineBasicMaterial?(o(f,d),d.isLineDashedMaterial&&a(f,d)):d.isPointsMaterial?l(f,d,S,x):d.isSpriteMaterial?u(f,d):d.isShadowMaterial?(f.color.value.copy(d.color),f.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(f,d){f.opacity.value=d.opacity,d.color&&f.diffuse.value.copy(d.color),d.emissive&&f.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(f.map.value=d.map,t(d.map,f.mapTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.bumpMap&&(f.bumpMap.value=d.bumpMap,t(d.bumpMap,f.bumpMapTransform),f.bumpScale.value=d.bumpScale,d.side===bt&&(f.bumpScale.value*=-1)),d.normalMap&&(f.normalMap.value=d.normalMap,t(d.normalMap,f.normalMapTransform),f.normalScale.value.copy(d.normalScale),d.side===bt&&f.normalScale.value.negate()),d.displacementMap&&(f.displacementMap.value=d.displacementMap,t(d.displacementMap,f.displacementMapTransform),f.displacementScale.value=d.displacementScale,f.displacementBias.value=d.displacementBias),d.emissiveMap&&(f.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,f.emissiveMapTransform)),d.specularMap&&(f.specularMap.value=d.specularMap,t(d.specularMap,f.specularMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest);const S=e.get(d).envMap;if(S&&(f.envMap.value=S,f.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=d.reflectivity,f.ior.value=d.ior,f.refractionRatio.value=d.refractionRatio),d.lightMap){f.lightMap.value=d.lightMap;const x=i._useLegacyLights===!0?Math.PI:1;f.lightMapIntensity.value=d.lightMapIntensity*x,t(d.lightMap,f.lightMapTransform)}d.aoMap&&(f.aoMap.value=d.aoMap,f.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,f.aoMapTransform))}function o(f,d){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,d.map&&(f.map.value=d.map,t(d.map,f.mapTransform))}function a(f,d){f.dashSize.value=d.dashSize,f.totalSize.value=d.dashSize+d.gapSize,f.scale.value=d.scale}function l(f,d,S,x){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,f.size.value=d.size*S,f.scale.value=x*.5,d.map&&(f.map.value=d.map,t(d.map,f.uvTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest)}function u(f,d){f.diffuse.value.copy(d.color),f.opacity.value=d.opacity,f.rotation.value=d.rotation,d.map&&(f.map.value=d.map,t(d.map,f.mapTransform)),d.alphaMap&&(f.alphaMap.value=d.alphaMap,t(d.alphaMap,f.alphaMapTransform)),d.alphaTest>0&&(f.alphaTest.value=d.alphaTest)}function h(f,d){f.specular.value.copy(d.specular),f.shininess.value=Math.max(d.shininess,1e-4)}function c(f,d){d.gradientMap&&(f.gradientMap.value=d.gradientMap)}function p(f,d){f.metalness.value=d.metalness,d.metalnessMap&&(f.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,f.metalnessMapTransform)),f.roughness.value=d.roughness,d.roughnessMap&&(f.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,f.roughnessMapTransform)),e.get(d).envMap&&(f.envMapIntensity.value=d.envMapIntensity)}function m(f,d,S){f.ior.value=d.ior,d.sheen>0&&(f.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),f.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(f.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,f.sheenColorMapTransform)),d.sheenRoughnessMap&&(f.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,f.sheenRoughnessMapTransform))),d.clearcoat>0&&(f.clearcoat.value=d.clearcoat,f.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(f.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,f.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(f.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===bt&&f.clearcoatNormalScale.value.negate())),d.iridescence>0&&(f.iridescence.value=d.iridescence,f.iridescenceIOR.value=d.iridescenceIOR,f.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(f.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,f.iridescenceMapTransform)),d.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),d.transmission>0&&(f.transmission.value=d.transmission,f.transmissionSamplerMap.value=S.texture,f.transmissionSamplerSize.value.set(S.width,S.height),d.transmissionMap&&(f.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,f.transmissionMapTransform)),f.thickness.value=d.thickness,d.thicknessMap&&(f.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=d.attenuationDistance,f.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(f.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(f.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=d.specularIntensity,f.specularColor.value.copy(d.specularColor),d.specularColorMap&&(f.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,f.specularColorMapTransform)),d.specularIntensityMap&&(f.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,f.specularIntensityMapTransform))}function g(f,d){d.matcap&&(f.matcap.value=d.matcap)}function _(f,d){const S=e.get(d).light;f.referencePosition.value.setFromMatrixPosition(S.matrixWorld),f.nearDistance.value=S.shadow.camera.near,f.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function um(i,e,t,n){let r={},s={},o=[];const a=t.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(S,x){const v=x.program;n.uniformBlockBinding(S,v)}function u(S,x){let v=r[S.id];v===void 0&&(g(S),v=h(S),r[S.id]=v,S.addEventListener("dispose",f));const C=x.program;n.updateUBOMapping(S,C);const w=e.render.frame;s[S.id]!==w&&(p(S),s[S.id]=w)}function h(S){const x=c();S.__bindingPointIndex=x;const v=i.createBuffer(),C=S.__size,w=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,v),i.bufferData(i.UNIFORM_BUFFER,C,w),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,x,v),v}function c(){for(let S=0;S<a;S++)if(o.indexOf(S)===-1)return o.push(S),S;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(S){const x=r[S.id],v=S.uniforms,C=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,x);for(let w=0,A=v.length;w<A;w++){const k=Array.isArray(v[w])?v[w]:[v[w]];for(let y=0,T=k.length;y<T;y++){const O=k[y];if(m(O,w,y,C)===!0){const W=O.__offset,Z=Array.isArray(O.value)?O.value:[O.value];let P=0;for(let F=0;F<Z.length;F++){const z=Z[F],q=_(z);typeof z=="number"||typeof z=="boolean"?(O.__data[0]=z,i.bufferSubData(i.UNIFORM_BUFFER,W+P,O.__data)):z.isMatrix3?(O.__data[0]=z.elements[0],O.__data[1]=z.elements[1],O.__data[2]=z.elements[2],O.__data[3]=0,O.__data[4]=z.elements[3],O.__data[5]=z.elements[4],O.__data[6]=z.elements[5],O.__data[7]=0,O.__data[8]=z.elements[6],O.__data[9]=z.elements[7],O.__data[10]=z.elements[8],O.__data[11]=0):(z.toArray(O.__data,P),P+=q.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,W,O.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(S,x,v,C){const w=S.value,A=x+"_"+v;if(C[A]===void 0)return typeof w=="number"||typeof w=="boolean"?C[A]=w:C[A]=w.clone(),!0;{const k=C[A];if(typeof w=="number"||typeof w=="boolean"){if(k!==w)return C[A]=w,!0}else if(k.equals(w)===!1)return k.copy(w),!0}return!1}function g(S){const x=S.uniforms;let v=0;const C=16;for(let A=0,k=x.length;A<k;A++){const y=Array.isArray(x[A])?x[A]:[x[A]];for(let T=0,O=y.length;T<O;T++){const W=y[T],Z=Array.isArray(W.value)?W.value:[W.value];for(let P=0,F=Z.length;P<F;P++){const z=Z[P],q=_(z),K=v%C;K!==0&&C-K<q.boundary&&(v+=C-K),W.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=v,v+=q.storage}}}const w=v%C;return w>0&&(v+=C-w),S.__size=v,S.__cache={},this}function _(S){const x={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(x.boundary=4,x.storage=4):S.isVector2?(x.boundary=8,x.storage=8):S.isVector3||S.isColor?(x.boundary=16,x.storage=12):S.isVector4?(x.boundary=16,x.storage=16):S.isMatrix3?(x.boundary=48,x.storage=48):S.isMatrix4?(x.boundary=64,x.storage=64):S.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",S),x}function f(S){const x=S.target;x.removeEventListener("dispose",f);const v=o.indexOf(x.__bindingPointIndex);o.splice(v,1),i.deleteBuffer(r[x.id]),delete r[x.id],delete s[x.id]}function d(){for(const S in r)i.deleteBuffer(r[S]);o=[],r={},s={}}return{bind:l,update:u,dispose:d}}class Il{constructor(e={}){const{canvas:t=su(),context:n=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:c=!1}=e;this.isWebGLRenderer=!0;let p;n!==null?p=n.getContextAttributes().alpha:p=o;const m=new Uint32Array(4),g=new Int32Array(4);let _=null,f=null;const d=[],S=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=pt,this._useLegacyLights=!1,this.toneMapping=_n,this.toneMappingExposure=1;const x=this;let v=!1,C=0,w=0,A=null,k=-1,y=null;const T=new $e,O=new $e;let W=null;const Z=new We(0);let P=0,F=t.width,z=t.height,q=1,K=null,j=null;const Q=new $e(0,0,F,z),re=new $e(0,0,F,z);let se=!1;const X=new Ys;let ne=!1,le=!1,Se=null;const ve=new nt,Re=new de,De=new D,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ce(){return A===null?q:1}let R=n;function oe(b,I){for(let G=0;G<b.length;G++){const V=b[G],B=t.getContext(V,I);if(B!==null)return B}return null}try{const b={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:h,failIfMajorPerformanceCaveat:c};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ks}`),t.addEventListener("webglcontextlost",ue,!1),t.addEventListener("webglcontextrestored",L,!1),t.addEventListener("webglcontextcreationerror",pe,!1),R===null){const I=["webgl2","webgl","experimental-webgl"];if(x.isWebGL1Renderer===!0&&I.shift(),R=oe(I,b),R===null)throw oe(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext!="undefined"&&R instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),R.getShaderPrecisionFormat===void 0&&(R.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Y,ae,J,be,ge,E,M,N,ie,ee,te,ye,fe,U,$,ce,H,_e,Ae,Ue,we,Me,Fe,Xe;function et(){Y=new Md(R),ae=new pd(R,Y,e),Y.init(ae),Me=new sm(R,Y,ae),J=new im(R,Y,ae),be=new Ed(R),ge=new kp,E=new rm(R,Y,J,ge,ae,Me,be),M=new gd(x),N=new xd(x),ie=new Lu(R,ae),Fe=new fd(R,Y,ie,ae),ee=new Sd(R,ie,be,Fe),te=new wd(R,ee,ie,be),Ae=new Ad(R,ae,E),ce=new md(ge),ye=new Vp(x,M,N,Y,ae,Fe,ce),fe=new cm(x,ge),U=new Xp,$=new $p(Y,ae),_e=new hd(x,M,N,J,te,p,l),H=new nm(x,te,ae),Xe=new um(R,be,ae,J),Ue=new dd(R,Y,be,ae),we=new yd(R,Y,be,ae),be.programs=ye.programs,x.capabilities=ae,x.extensions=Y,x.properties=ge,x.renderLists=U,x.shadowMap=H,x.state=J,x.info=be}et();const He=new lm(x,R);this.xr=He,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const b=Y.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Y.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(b){b!==void 0&&(q=b,this.setSize(F,z,!1))},this.getSize=function(b){return b.set(F,z)},this.setSize=function(b,I,G=!0){if(He.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}F=b,z=I,t.width=Math.floor(b*q),t.height=Math.floor(I*q),G===!0&&(t.style.width=b+"px",t.style.height=I+"px"),this.setViewport(0,0,b,I)},this.getDrawingBufferSize=function(b){return b.set(F*q,z*q).floor()},this.setDrawingBufferSize=function(b,I,G){F=b,z=I,q=G,t.width=Math.floor(b*G),t.height=Math.floor(I*G),this.setViewport(0,0,b,I)},this.getCurrentViewport=function(b){return b.copy(T)},this.getViewport=function(b){return b.copy(Q)},this.setViewport=function(b,I,G,V){b.isVector4?Q.set(b.x,b.y,b.z,b.w):Q.set(b,I,G,V),J.viewport(T.copy(Q).multiplyScalar(q).floor())},this.getScissor=function(b){return b.copy(re)},this.setScissor=function(b,I,G,V){b.isVector4?re.set(b.x,b.y,b.z,b.w):re.set(b,I,G,V),J.scissor(O.copy(re).multiplyScalar(q).floor())},this.getScissorTest=function(){return se},this.setScissorTest=function(b){J.setScissorTest(se=b)},this.setOpaqueSort=function(b){K=b},this.setTransparentSort=function(b){j=b},this.getClearColor=function(b){return b.copy(_e.getClearColor())},this.setClearColor=function(){_e.setClearColor.apply(_e,arguments)},this.getClearAlpha=function(){return _e.getClearAlpha()},this.setClearAlpha=function(){_e.setClearAlpha.apply(_e,arguments)},this.clear=function(b=!0,I=!0,G=!0){let V=0;if(b){let B=!1;if(A!==null){const xe=A.texture.format;B=xe===cl||xe===ll||xe===ol}if(B){const xe=A.texture.type,Te=xe===vn||xe===pn||xe===Xs||xe===Un||xe===sl||xe===al,Pe=_e.getClearColor(),Ne=_e.getClearAlpha(),Ge=Pe.r,Oe=Pe.g,Be=Pe.b;Te?(m[0]=Ge,m[1]=Oe,m[2]=Be,m[3]=Ne,R.clearBufferuiv(R.COLOR,0,m)):(g[0]=Ge,g[1]=Oe,g[2]=Be,g[3]=Ne,R.clearBufferiv(R.COLOR,0,g))}else V|=R.COLOR_BUFFER_BIT}I&&(V|=R.DEPTH_BUFFER_BIT),G&&(V|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ue,!1),t.removeEventListener("webglcontextrestored",L,!1),t.removeEventListener("webglcontextcreationerror",pe,!1),U.dispose(),$.dispose(),ge.dispose(),M.dispose(),N.dispose(),te.dispose(),Fe.dispose(),Xe.dispose(),ye.dispose(),He.dispose(),He.removeEventListener("sessionstart",xt),He.removeEventListener("sessionend",Ke),Se&&(Se.dispose(),Se=null),Mt.stop()};function ue(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),v=!0}function L(){console.log("THREE.WebGLRenderer: Context Restored."),v=!1;const b=be.autoReset,I=H.enabled,G=H.autoUpdate,V=H.needsUpdate,B=H.type;et(),be.autoReset=b,H.enabled=I,H.autoUpdate=G,H.needsUpdate=V,H.type=B}function pe(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function me(b){const I=b.target;I.removeEventListener("dispose",me),Ie(I)}function Ie(b){Le(b),ge.remove(b)}function Le(b){const I=ge.get(b).programs;I!==void 0&&(I.forEach(function(G){ye.releaseProgram(G)}),b.isShaderMaterial&&ye.releaseShaderCache(b))}this.renderBufferDirect=function(b,I,G,V,B,xe){I===null&&(I=Ee);const Te=B.isMesh&&B.matrixWorld.determinant()<0,Pe=jl(b,I,G,V,B);J.setMaterial(V,Te);let Ne=G.index,Ge=1;if(V.wireframe===!0){if(Ne=ee.getWireframeAttribute(G),Ne===void 0)return;Ge=2}const Oe=G.drawRange,Be=G.attributes.position;let it=Oe.start*Ge,At=(Oe.start+Oe.count)*Ge;xe!==null&&(it=Math.max(it,xe.start*Ge),At=Math.min(At,(xe.start+xe.count)*Ge)),Ne!==null?(it=Math.max(it,0),At=Math.min(At,Ne.count)):Be!=null&&(it=Math.max(it,0),At=Math.min(At,Be.count));const ut=At-it;if(ut<0||ut===1/0)return;Fe.setup(B,V,Pe,G,Ne);let Zt,je=Ue;if(Ne!==null&&(Zt=ie.get(Ne),je=we,je.setIndex(Zt)),B.isMesh)V.wireframe===!0?(J.setLineWidth(V.wireframeLinewidth*Ce()),je.setMode(R.LINES)):je.setMode(R.TRIANGLES);else if(B.isLine){let Ve=V.linewidth;Ve===void 0&&(Ve=1),J.setLineWidth(Ve*Ce()),B.isLineSegments?je.setMode(R.LINES):B.isLineLoop?je.setMode(R.LINE_LOOP):je.setMode(R.LINE_STRIP)}else B.isPoints?je.setMode(R.POINTS):B.isSprite&&je.setMode(R.TRIANGLES);if(B.isBatchedMesh)je.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else if(B.isInstancedMesh)je.renderInstances(it,ut,B.count);else if(G.isInstancedBufferGeometry){const Ve=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,Fr=Math.min(G.instanceCount,Ve);je.renderInstances(it,ut,Fr)}else je.render(it,ut)};function Ye(b,I,G){b.transparent===!0&&b.side===Jt&&b.forceSinglePass===!1?(b.side=bt,b.needsUpdate=!0,qi(b,I,G),b.side=Mn,b.needsUpdate=!0,qi(b,I,G),b.side=Jt):qi(b,I,G)}this.compile=function(b,I,G=null){G===null&&(G=b),f=$.get(G),f.init(),S.push(f),G.traverseVisible(function(B){B.isLight&&B.layers.test(I.layers)&&(f.pushLight(B),B.castShadow&&f.pushShadow(B))}),b!==G&&b.traverseVisible(function(B){B.isLight&&B.layers.test(I.layers)&&(f.pushLight(B),B.castShadow&&f.pushShadow(B))}),f.setupLights(x._useLegacyLights);const V=new Set;return b.traverse(function(B){const xe=B.material;if(xe)if(Array.isArray(xe))for(let Te=0;Te<xe.length;Te++){const Pe=xe[Te];Ye(Pe,G,B),V.add(Pe)}else Ye(xe,G,B),V.add(xe)}),S.pop(),f=null,V},this.compileAsync=function(b,I,G=null){const V=this.compile(b,I,G);return new Promise(B=>{function xe(){if(V.forEach(function(Te){ge.get(Te).currentProgram.isReady()&&V.delete(Te)}),V.size===0){B(b);return}setTimeout(xe,10)}Y.get("KHR_parallel_shader_compile")!==null?xe():setTimeout(xe,10)})};let Je=null;function ct(b){Je&&Je(b)}function xt(){Mt.stop()}function Ke(){Mt.start()}const Mt=new Al;Mt.setAnimationLoop(ct),typeof self!="undefined"&&Mt.setContext(self),this.setAnimationLoop=function(b){Je=b,He.setAnimationLoop(b),b===null?Mt.stop():Mt.start()},He.addEventListener("sessionstart",xt),He.addEventListener("sessionend",Ke),this.render=function(b,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(v===!0)return;b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),He.enabled===!0&&He.isPresenting===!0&&(He.cameraAutoUpdate===!0&&He.updateCamera(I),I=He.getCamera()),b.isScene===!0&&b.onBeforeRender(x,b,I,A),f=$.get(b,S.length),f.init(),S.push(f),ve.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),X.setFromProjectionMatrix(ve),le=this.localClippingEnabled,ne=ce.init(this.clippingPlanes,le),_=U.get(b,d.length),_.init(),d.push(_),kt(b,I,0,x.sortObjects),_.finish(),x.sortObjects===!0&&_.sort(K,j),this.info.render.frame++,ne===!0&&ce.beginShadows();const G=f.state.shadowsArray;if(H.render(G,b,I),ne===!0&&ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),_e.render(_,b),f.setupLights(x._useLegacyLights),I.isArrayCamera){const V=I.cameras;for(let B=0,xe=V.length;B<xe;B++){const Te=V[B];ra(_,b,Te,Te.viewport)}}else ra(_,b,I);A!==null&&(E.updateMultisampleRenderTarget(A),E.updateRenderTargetMipmap(A)),b.isScene===!0&&b.onAfterRender(x,b,I),Fe.resetDefaultState(),k=-1,y=null,S.pop(),S.length>0?f=S[S.length-1]:f=null,d.pop(),d.length>0?_=d[d.length-1]:_=null};function kt(b,I,G,V){if(b.visible===!1)return;if(b.layers.test(I.layers)){if(b.isGroup)G=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(I);else if(b.isLight)f.pushLight(b),b.castShadow&&f.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||X.intersectsSprite(b)){V&&De.setFromMatrixPosition(b.matrixWorld).applyMatrix4(ve);const Te=te.update(b),Pe=b.material;Pe.visible&&_.push(b,Te,Pe,G,De.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||X.intersectsObject(b))){const Te=te.update(b),Pe=b.material;if(V&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),De.copy(b.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),De.copy(Te.boundingSphere.center)),De.applyMatrix4(b.matrixWorld).applyMatrix4(ve)),Array.isArray(Pe)){const Ne=Te.groups;for(let Ge=0,Oe=Ne.length;Ge<Oe;Ge++){const Be=Ne[Ge],it=Pe[Be.materialIndex];it&&it.visible&&_.push(b,Te,it,G,De.z,Be)}}else Pe.visible&&_.push(b,Te,Pe,G,De.z,null)}}const xe=b.children;for(let Te=0,Pe=xe.length;Te<Pe;Te++)kt(xe[Te],I,G,V)}function ra(b,I,G,V){const B=b.opaque,xe=b.transmissive,Te=b.transparent;f.setupLightsView(G),ne===!0&&ce.setGlobalState(x.clippingPlanes,G),xe.length>0&&$l(B,xe,I,G),V&&J.viewport(T.copy(V)),B.length>0&&Xi(B,I,G),xe.length>0&&Xi(xe,I,G),Te.length>0&&Xi(Te,I,G),J.buffers.depth.setTest(!0),J.buffers.depth.setMask(!0),J.buffers.color.setMask(!0),J.setPolygonOffset(!1)}function $l(b,I,G,V){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;const xe=ae.isWebGL2;Se===null&&(Se=new Fn(1,1,{generateMipmaps:!0,type:Y.has("EXT_color_buffer_half_float")?Oi:vn,minFilter:Ni,samples:xe?4:0})),x.getDrawingBufferSize(Re),xe?Se.setSize(Re.x,Re.y):Se.setSize(Us(Re.x),Us(Re.y));const Te=x.getRenderTarget();x.setRenderTarget(Se),x.getClearColor(Z),P=x.getClearAlpha(),P<1&&x.setClearColor(16777215,.5),x.clear();const Pe=x.toneMapping;x.toneMapping=_n,Xi(b,G,V),E.updateMultisampleRenderTarget(Se),E.updateRenderTargetMipmap(Se);let Ne=!1;for(let Ge=0,Oe=I.length;Ge<Oe;Ge++){const Be=I[Ge],it=Be.object,At=Be.geometry,ut=Be.material,Zt=Be.group;if(ut.side===Jt&&it.layers.test(V.layers)){const je=ut.side;ut.side=bt,ut.needsUpdate=!0,sa(it,G,V,At,ut,Zt),ut.side=je,ut.needsUpdate=!0,Ne=!0}}Ne===!0&&(E.updateMultisampleRenderTarget(Se),E.updateRenderTargetMipmap(Se)),x.setRenderTarget(Te),x.setClearColor(Z,P),x.toneMapping=Pe}function Xi(b,I,G){const V=I.isScene===!0?I.overrideMaterial:null;for(let B=0,xe=b.length;B<xe;B++){const Te=b[B],Pe=Te.object,Ne=Te.geometry,Ge=V===null?Te.material:V,Oe=Te.group;Pe.layers.test(G.layers)&&sa(Pe,I,G,Ne,Ge,Oe)}}function sa(b,I,G,V,B,xe){b.onBeforeRender(x,I,G,V,B,xe),b.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),B.onBeforeRender(x,I,G,V,b,xe),B.transparent===!0&&B.side===Jt&&B.forceSinglePass===!1?(B.side=bt,B.needsUpdate=!0,x.renderBufferDirect(G,I,V,B,b,xe),B.side=Mn,B.needsUpdate=!0,x.renderBufferDirect(G,I,V,B,b,xe),B.side=Jt):x.renderBufferDirect(G,I,V,B,b,xe),b.onAfterRender(x,I,G,V,B,xe)}function qi(b,I,G){I.isScene!==!0&&(I=Ee);const V=ge.get(b),B=f.state.lights,xe=f.state.shadowsArray,Te=B.state.version,Pe=ye.getParameters(b,B.state,xe,I,G),Ne=ye.getProgramCacheKey(Pe);let Ge=V.programs;V.environment=b.isMeshStandardMaterial?I.environment:null,V.fog=I.fog,V.envMap=(b.isMeshStandardMaterial?N:M).get(b.envMap||V.environment),Ge===void 0&&(b.addEventListener("dispose",me),Ge=new Map,V.programs=Ge);let Oe=Ge.get(Ne);if(Oe!==void 0){if(V.currentProgram===Oe&&V.lightsStateVersion===Te)return oa(b,Pe),Oe}else Pe.uniforms=ye.getUniforms(b),b.onBuild(G,Pe,x),b.onBeforeCompile(Pe,x),Oe=ye.acquireProgram(Pe,Ne),Ge.set(Ne,Oe),V.uniforms=Pe.uniforms;const Be=V.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Be.clippingPlanes=ce.uniform),oa(b,Pe),V.needsLights=ec(b),V.lightsStateVersion=Te,V.needsLights&&(Be.ambientLightColor.value=B.state.ambient,Be.lightProbe.value=B.state.probe,Be.directionalLights.value=B.state.directional,Be.directionalLightShadows.value=B.state.directionalShadow,Be.spotLights.value=B.state.spot,Be.spotLightShadows.value=B.state.spotShadow,Be.rectAreaLights.value=B.state.rectArea,Be.ltc_1.value=B.state.rectAreaLTC1,Be.ltc_2.value=B.state.rectAreaLTC2,Be.pointLights.value=B.state.point,Be.pointLightShadows.value=B.state.pointShadow,Be.hemisphereLights.value=B.state.hemi,Be.directionalShadowMap.value=B.state.directionalShadowMap,Be.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Be.spotShadowMap.value=B.state.spotShadowMap,Be.spotLightMatrix.value=B.state.spotLightMatrix,Be.spotLightMap.value=B.state.spotLightMap,Be.pointShadowMap.value=B.state.pointShadowMap,Be.pointShadowMatrix.value=B.state.pointShadowMatrix),V.currentProgram=Oe,V.uniformsList=null,Oe}function aa(b){if(b.uniformsList===null){const I=b.currentProgram.getUniforms();b.uniformsList=Mr.seqWithValue(I.seq,b.uniforms)}return b.uniformsList}function oa(b,I){const G=ge.get(b);G.outputColorSpace=I.outputColorSpace,G.batching=I.batching,G.instancing=I.instancing,G.instancingColor=I.instancingColor,G.skinning=I.skinning,G.morphTargets=I.morphTargets,G.morphNormals=I.morphNormals,G.morphColors=I.morphColors,G.morphTargetsCount=I.morphTargetsCount,G.numClippingPlanes=I.numClippingPlanes,G.numIntersection=I.numClipIntersection,G.vertexAlphas=I.vertexAlphas,G.vertexTangents=I.vertexTangents,G.toneMapping=I.toneMapping}function jl(b,I,G,V,B){I.isScene!==!0&&(I=Ee),E.resetTextureUnits();const xe=I.fog,Te=V.isMeshStandardMaterial?I.environment:null,Pe=A===null?x.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:ln,Ne=(V.isMeshStandardMaterial?N:M).get(V.envMap||Te),Ge=V.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Oe=!!G.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Be=!!G.morphAttributes.position,it=!!G.morphAttributes.normal,At=!!G.morphAttributes.color;let ut=_n;V.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(ut=x.toneMapping);const Zt=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,je=Zt!==void 0?Zt.length:0,Ve=ge.get(V),Fr=f.state.lights;if(ne===!0&&(le===!0||b!==y)){const Pt=b===y&&V.id===k;ce.setState(V,b,Pt)}let tt=!1;V.version===Ve.__version?(Ve.needsLights&&Ve.lightsStateVersion!==Fr.state.version||Ve.outputColorSpace!==Pe||B.isBatchedMesh&&Ve.batching===!1||!B.isBatchedMesh&&Ve.batching===!0||B.isInstancedMesh&&Ve.instancing===!1||!B.isInstancedMesh&&Ve.instancing===!0||B.isSkinnedMesh&&Ve.skinning===!1||!B.isSkinnedMesh&&Ve.skinning===!0||B.isInstancedMesh&&Ve.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Ve.instancingColor===!1&&B.instanceColor!==null||Ve.envMap!==Ne||V.fog===!0&&Ve.fog!==xe||Ve.numClippingPlanes!==void 0&&(Ve.numClippingPlanes!==ce.numPlanes||Ve.numIntersection!==ce.numIntersection)||Ve.vertexAlphas!==Ge||Ve.vertexTangents!==Oe||Ve.morphTargets!==Be||Ve.morphNormals!==it||Ve.morphColors!==At||Ve.toneMapping!==ut||ae.isWebGL2===!0&&Ve.morphTargetsCount!==je)&&(tt=!0):(tt=!0,Ve.__version=V.version);let Sn=Ve.currentProgram;tt===!0&&(Sn=qi(V,I,B));let la=!1,xi=!1,Br=!1;const mt=Sn.getUniforms(),yn=Ve.uniforms;if(J.useProgram(Sn.program)&&(la=!0,xi=!0,Br=!0),V.id!==k&&(k=V.id,xi=!0),la||y!==b){mt.setValue(R,"projectionMatrix",b.projectionMatrix),mt.setValue(R,"viewMatrix",b.matrixWorldInverse);const Pt=mt.map.cameraPosition;Pt!==void 0&&Pt.setValue(R,De.setFromMatrixPosition(b.matrixWorld)),ae.logarithmicDepthBuffer&&mt.setValue(R,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&mt.setValue(R,"isOrthographic",b.isOrthographicCamera===!0),y!==b&&(y=b,xi=!0,Br=!0)}if(B.isSkinnedMesh){mt.setOptional(R,B,"bindMatrix"),mt.setOptional(R,B,"bindMatrixInverse");const Pt=B.skeleton;Pt&&(ae.floatVertexTextures?(Pt.boneTexture===null&&Pt.computeBoneTexture(),mt.setValue(R,"boneTexture",Pt.boneTexture,E)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}B.isBatchedMesh&&(mt.setOptional(R,B,"batchingTexture"),mt.setValue(R,"batchingTexture",B._matricesTexture,E));const zr=G.morphAttributes;if((zr.position!==void 0||zr.normal!==void 0||zr.color!==void 0&&ae.isWebGL2===!0)&&Ae.update(B,G,Sn),(xi||Ve.receiveShadow!==B.receiveShadow)&&(Ve.receiveShadow=B.receiveShadow,mt.setValue(R,"receiveShadow",B.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(yn.envMap.value=Ne,yn.flipEnvMap.value=Ne.isCubeTexture&&Ne.isRenderTargetTexture===!1?-1:1),xi&&(mt.setValue(R,"toneMappingExposure",x.toneMappingExposure),Ve.needsLights&&Ql(yn,Br),xe&&V.fog===!0&&fe.refreshFogUniforms(yn,xe),fe.refreshMaterialUniforms(yn,V,q,z,Se),Mr.upload(R,aa(Ve),yn,E)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Mr.upload(R,aa(Ve),yn,E),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&mt.setValue(R,"center",B.center),mt.setValue(R,"modelViewMatrix",B.modelViewMatrix),mt.setValue(R,"normalMatrix",B.normalMatrix),mt.setValue(R,"modelMatrix",B.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Pt=V.uniformsGroups;for(let Gr=0,tc=Pt.length;Gr<tc;Gr++)if(ae.isWebGL2){const ca=Pt[Gr];Xe.update(ca,Sn),Xe.bind(ca,Sn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Sn}function Ql(b,I){b.ambientLightColor.needsUpdate=I,b.lightProbe.needsUpdate=I,b.directionalLights.needsUpdate=I,b.directionalLightShadows.needsUpdate=I,b.pointLights.needsUpdate=I,b.pointLightShadows.needsUpdate=I,b.spotLights.needsUpdate=I,b.spotLightShadows.needsUpdate=I,b.rectAreaLights.needsUpdate=I,b.hemisphereLights.needsUpdate=I}function ec(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(b,I,G){ge.get(b.texture).__webglTexture=I,ge.get(b.depthTexture).__webglTexture=G;const V=ge.get(b);V.__hasExternalTextures=!0,V.__hasExternalTextures&&(V.__autoAllocateDepthBuffer=G===void 0,V.__autoAllocateDepthBuffer||Y.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(b,I){const G=ge.get(b);G.__webglFramebuffer=I,G.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(b,I=0,G=0){A=b,C=I,w=G;let V=!0,B=null,xe=!1,Te=!1;if(b){const Ne=ge.get(b);Ne.__useDefaultFramebuffer!==void 0?(J.bindFramebuffer(R.FRAMEBUFFER,null),V=!1):Ne.__webglFramebuffer===void 0?E.setupRenderTarget(b):Ne.__hasExternalTextures&&E.rebindTextures(b,ge.get(b.texture).__webglTexture,ge.get(b.depthTexture).__webglTexture);const Ge=b.texture;(Ge.isData3DTexture||Ge.isDataArrayTexture||Ge.isCompressedArrayTexture)&&(Te=!0);const Oe=ge.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Oe[I])?B=Oe[I][G]:B=Oe[I],xe=!0):ae.isWebGL2&&b.samples>0&&E.useMultisampledRTT(b)===!1?B=ge.get(b).__webglMultisampledFramebuffer:Array.isArray(Oe)?B=Oe[G]:B=Oe,T.copy(b.viewport),O.copy(b.scissor),W=b.scissorTest}else T.copy(Q).multiplyScalar(q).floor(),O.copy(re).multiplyScalar(q).floor(),W=se;if(J.bindFramebuffer(R.FRAMEBUFFER,B)&&ae.drawBuffers&&V&&J.drawBuffers(b,B),J.viewport(T),J.scissor(O),J.setScissorTest(W),xe){const Ne=ge.get(b.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ne.__webglTexture,G)}else if(Te){const Ne=ge.get(b.texture),Ge=I||0;R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,Ne.__webglTexture,G||0,Ge)}k=-1},this.readRenderTargetPixels=function(b,I,G,V,B,xe,Te){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=ge.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Te!==void 0&&(Pe=Pe[Te]),Pe){J.bindFramebuffer(R.FRAMEBUFFER,Pe);try{const Ne=b.texture,Ge=Ne.format,Oe=Ne.type;if(Ge!==Ht&&Me.convert(Ge)!==R.getParameter(R.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Be=Oe===Oi&&(Y.has("EXT_color_buffer_half_float")||ae.isWebGL2&&Y.has("EXT_color_buffer_float"));if(Oe!==vn&&Me.convert(Oe)!==R.getParameter(R.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Oe===mn&&(ae.isWebGL2||Y.has("OES_texture_float")||Y.has("WEBGL_color_buffer_float")))&&!Be){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=b.width-V&&G>=0&&G<=b.height-B&&R.readPixels(I,G,V,B,Me.convert(Ge),Me.convert(Oe),xe)}finally{const Ne=A!==null?ge.get(A).__webglFramebuffer:null;J.bindFramebuffer(R.FRAMEBUFFER,Ne)}}},this.copyFramebufferToTexture=function(b,I,G=0){const V=Math.pow(2,-G),B=Math.floor(I.image.width*V),xe=Math.floor(I.image.height*V);E.setTexture2D(I,0),R.copyTexSubImage2D(R.TEXTURE_2D,G,0,0,b.x,b.y,B,xe),J.unbindTexture()},this.copyTextureToTexture=function(b,I,G,V=0){const B=I.image.width,xe=I.image.height,Te=Me.convert(G.format),Pe=Me.convert(G.type);E.setTexture2D(G,0),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,G.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,G.unpackAlignment),I.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,V,b.x,b.y,B,xe,Te,Pe,I.image.data):I.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,V,b.x,b.y,I.mipmaps[0].width,I.mipmaps[0].height,Te,I.mipmaps[0].data):R.texSubImage2D(R.TEXTURE_2D,V,b.x,b.y,Te,Pe,I.image),V===0&&G.generateMipmaps&&R.generateMipmap(R.TEXTURE_2D),J.unbindTexture()},this.copyTextureToTexture3D=function(b,I,G,V,B=0){if(x.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const xe=b.max.x-b.min.x+1,Te=b.max.y-b.min.y+1,Pe=b.max.z-b.min.z+1,Ne=Me.convert(V.format),Ge=Me.convert(V.type);let Oe;if(V.isData3DTexture)E.setTexture3D(V,0),Oe=R.TEXTURE_3D;else if(V.isDataArrayTexture||V.isCompressedArrayTexture)E.setTexture2DArray(V,0),Oe=R.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,V.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,V.unpackAlignment);const Be=R.getParameter(R.UNPACK_ROW_LENGTH),it=R.getParameter(R.UNPACK_IMAGE_HEIGHT),At=R.getParameter(R.UNPACK_SKIP_PIXELS),ut=R.getParameter(R.UNPACK_SKIP_ROWS),Zt=R.getParameter(R.UNPACK_SKIP_IMAGES),je=G.isCompressedTexture?G.mipmaps[B]:G.image;R.pixelStorei(R.UNPACK_ROW_LENGTH,je.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,je.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,b.min.x),R.pixelStorei(R.UNPACK_SKIP_ROWS,b.min.y),R.pixelStorei(R.UNPACK_SKIP_IMAGES,b.min.z),G.isDataTexture||G.isData3DTexture?R.texSubImage3D(Oe,B,I.x,I.y,I.z,xe,Te,Pe,Ne,Ge,je.data):G.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),R.compressedTexSubImage3D(Oe,B,I.x,I.y,I.z,xe,Te,Pe,Ne,je.data)):R.texSubImage3D(Oe,B,I.x,I.y,I.z,xe,Te,Pe,Ne,Ge,je),R.pixelStorei(R.UNPACK_ROW_LENGTH,Be),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,it),R.pixelStorei(R.UNPACK_SKIP_PIXELS,At),R.pixelStorei(R.UNPACK_SKIP_ROWS,ut),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Zt),B===0&&V.generateMipmaps&&R.generateMipmap(Oe),J.unbindTexture()},this.initTexture=function(b){b.isCubeTexture?E.setTextureCube(b,0):b.isData3DTexture?E.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?E.setTexture2DArray(b,0):E.setTexture2D(b,0),J.unbindTexture()},this.resetState=function(){C=0,w=0,A=null,J.reset(),Fe.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return on}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===qs?"display-p3":"srgb",t.unpackColorSpace=qe.workingColorSpace===Pr?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===pt?Nn:hl}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Nn?pt:ln}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class hm extends Il{}hm.prototype.isWebGL1Renderer=!0;class Zs{constructor(e,t=1,n=1e3){this.isFog=!0,this.name="",this.color=new We(e),this.near=t,this.far=n}clone(){return new Zs(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class fm extends ft{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class Nl extends _i{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new We(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Do=new nt,Ns=new vl,mr=new Dr,gr=new D;class dm extends ft{constructor(e=new Lt,t=new Nl){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const n=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),mr.copy(n.boundingSphere),mr.applyMatrix4(r),mr.radius+=s,e.ray.intersectsSphere(mr)===!1)return;Do.copy(r).invert(),Ns.copy(e.ray).applyMatrix4(Do);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=n.index,c=n.attributes.position;if(u!==null){const p=Math.max(0,o.start),m=Math.min(u.count,o.start+o.count);for(let g=p,_=m;g<_;g++){const f=u.getX(g);gr.fromBufferAttribute(c,f),Uo(gr,f,l,r,e,t,this)}}else{const p=Math.max(0,o.start),m=Math.min(c.count,o.start+o.count);for(let g=p,_=m;g<_;g++)gr.fromBufferAttribute(c,g),Uo(gr,g,l,r,e,t,this)}}updateMorphTargets(){const t=this.geometry.morphAttributes,n=Object.keys(t);if(n.length>0){const r=t[n[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function Uo(i,e,t,n,r,s,o){const a=Ns.distanceSqToPoint(i);if(a<t){const l=new D;Ns.closestPointToPoint(i,l),l.applyMatrix4(n);const u=r.ray.origin.distanceTo(l);if(u<r.near||u>r.far)return;s.push({distance:u,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,object:o})}}class pm extends Tt{constructor(e,t,n,r,s,o,a,l,u){super(e,t,n,r,s,o,a,l,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Kt{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const n=this.getUtoTmapping(e);return this.getPoint(n,t)}getPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return t}getSpacedPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPointAt(n/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let n,r=this.getPoint(0),s=0;t.push(0);for(let o=1;o<=e;o++)n=this.getPoint(o/e),s+=n.distanceTo(r),t.push(s),r=n;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const n=this.getLengths();let r=0;const s=n.length;let o;t?o=t:o=e*n[s-1];let a=0,l=s-1,u;for(;a<=l;)if(r=Math.floor(a+(l-a)/2),u=n[r]-o,u<0)a=r+1;else if(u>0)l=r-1;else{l=r;break}if(r=l,n[r]===o)return r/(s-1);const h=n[r],p=n[r+1]-h,m=(o-h)/p;return(r+m)/(s-1)}getTangent(e,t){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const o=this.getPoint(r),a=this.getPoint(s),l=t||(o.isVector2?new de:new D);return l.copy(a).sub(o).normalize(),l}getTangentAt(e,t){const n=this.getUtoTmapping(e);return this.getTangent(n,t)}computeFrenetFrames(e,t){const n=new D,r=[],s=[],o=[],a=new D,l=new nt;for(let m=0;m<=e;m++){const g=m/e;r[m]=this.getTangentAt(g,new D)}s[0]=new D,o[0]=new D;let u=Number.MAX_VALUE;const h=Math.abs(r[0].x),c=Math.abs(r[0].y),p=Math.abs(r[0].z);h<=u&&(u=h,n.set(1,0,0)),c<=u&&(u=c,n.set(0,1,0)),p<=u&&n.set(0,0,1),a.crossVectors(r[0],n).normalize(),s[0].crossVectors(r[0],a),o[0].crossVectors(r[0],s[0]);for(let m=1;m<=e;m++){if(s[m]=s[m-1].clone(),o[m]=o[m-1].clone(),a.crossVectors(r[m-1],r[m]),a.length()>Number.EPSILON){a.normalize();const g=Math.acos(vt(r[m-1].dot(r[m]),-1,1));s[m].applyMatrix4(l.makeRotationAxis(a,g))}o[m].crossVectors(r[m],s[m])}if(t===!0){let m=Math.acos(vt(s[0].dot(s[e]),-1,1));m/=e,r[0].dot(a.crossVectors(s[0],s[e]))>0&&(m=-m);for(let g=1;g<=e;g++)s[g].applyMatrix4(l.makeRotationAxis(r[g],m*g)),o[g].crossVectors(r[g],s[g])}return{tangents:r,normals:s,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class $s extends Kt{constructor(e=0,t=0,n=1,r=1,s=0,o=Math.PI*2,a=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=n,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=o,this.aClockwise=a,this.aRotation=l}getPoint(e,t){const n=t||new de,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const o=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(o?s=0:s=r),this.aClockwise===!0&&!o&&(s===r?s=-r:s=s-r);const a=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(a),u=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),c=Math.sin(this.aRotation),p=l-this.aX,m=u-this.aY;l=p*h-m*c+this.aX,u=p*c+m*h+this.aY}return n.set(l,u)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class mm extends $s{constructor(e,t,n,r,s,o){super(e,t,n,n,r,s,o),this.isArcCurve=!0,this.type="ArcCurve"}}function js(){let i=0,e=0,t=0,n=0;function r(s,o,a,l){i=s,e=a,t=-3*s+3*o-2*a-l,n=2*s-2*o+a+l}return{initCatmullRom:function(s,o,a,l,u){r(o,a,u*(a-s),u*(l-o))},initNonuniformCatmullRom:function(s,o,a,l,u,h,c){let p=(o-s)/u-(a-s)/(u+h)+(a-o)/h,m=(a-o)/h-(l-o)/(h+c)+(l-a)/c;p*=h,m*=h,r(o,a,p,m)},calc:function(s){const o=s*s,a=o*s;return i+e*s+t*o+n*a}}}const _r=new D,vs=new js,xs=new js,Ms=new js;class gm extends Kt{constructor(e=[],t=!1,n="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=n,this.tension=r}getPoint(e,t=new D){const n=t,r=this.points,s=r.length,o=(s-(this.closed?0:1))*e;let a=Math.floor(o),l=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/s)+1)*s:l===0&&a===s-1&&(a=s-2,l=1);let u,h;this.closed||a>0?u=r[(a-1)%s]:(_r.subVectors(r[0],r[1]).add(r[0]),u=_r);const c=r[a%s],p=r[(a+1)%s];if(this.closed||a+2<s?h=r[(a+2)%s]:(_r.subVectors(r[s-1],r[s-2]).add(r[s-1]),h=_r),this.curveType==="centripetal"||this.curveType==="chordal"){const m=this.curveType==="chordal"?.5:.25;let g=Math.pow(u.distanceToSquared(c),m),_=Math.pow(c.distanceToSquared(p),m),f=Math.pow(p.distanceToSquared(h),m);_<1e-4&&(_=1),g<1e-4&&(g=_),f<1e-4&&(f=_),vs.initNonuniformCatmullRom(u.x,c.x,p.x,h.x,g,_,f),xs.initNonuniformCatmullRom(u.y,c.y,p.y,h.y,g,_,f),Ms.initNonuniformCatmullRom(u.z,c.z,p.z,h.z,g,_,f)}else this.curveType==="catmullrom"&&(vs.initCatmullRom(u.x,c.x,p.x,h.x,this.tension),xs.initCatmullRom(u.y,c.y,p.y,h.y,this.tension),Ms.initCatmullRom(u.z,c.z,p.z,h.z,this.tension));return n.set(vs.calc(l),xs.calc(l),Ms.calc(l)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new D().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Io(i,e,t,n,r){const s=(n-e)*.5,o=(r-t)*.5,a=i*i,l=i*a;return(2*t-2*n+s+o)*l+(-3*t+3*n-2*s-o)*a+s*i+t}function _m(i,e){const t=1-i;return t*t*e}function vm(i,e){return 2*(1-i)*i*e}function xm(i,e){return i*i*e}function Ci(i,e,t,n){return _m(i,e)+vm(i,t)+xm(i,n)}function Mm(i,e){const t=1-i;return t*t*t*e}function Sm(i,e){const t=1-i;return 3*t*t*i*e}function ym(i,e){return 3*(1-i)*i*i*e}function Em(i,e){return i*i*i*e}function Li(i,e,t,n,r){return Mm(i,e)+Sm(i,t)+ym(i,n)+Em(i,r)}class Ol extends Kt{constructor(e=new de,t=new de,n=new de,r=new de){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new de){const n=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return n.set(Li(e,r.x,s.x,o.x,a.x),Li(e,r.y,s.y,o.y,a.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class bm extends Kt{constructor(e=new D,t=new D,n=new D,r=new D){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new D){const n=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return n.set(Li(e,r.x,s.x,o.x,a.x),Li(e,r.y,s.y,o.y,a.y),Li(e,r.z,s.z,o.z,a.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class Fl extends Kt{constructor(e=new de,t=new de){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new de){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new de){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Tm extends Kt{constructor(e=new D,t=new D){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new D){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new D){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Bl extends Kt{constructor(e=new de,t=new de,n=new de){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new de){const n=t,r=this.v0,s=this.v1,o=this.v2;return n.set(Ci(e,r.x,s.x,o.x),Ci(e,r.y,s.y,o.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Am extends Kt{constructor(e=new D,t=new D,n=new D){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new D){const n=t,r=this.v0,s=this.v1,o=this.v2;return n.set(Ci(e,r.x,s.x,o.x),Ci(e,r.y,s.y,o.y),Ci(e,r.z,s.z,o.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class zl extends Kt{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new de){const n=t,r=this.points,s=(r.length-1)*e,o=Math.floor(s),a=s-o,l=r[o===0?o:o-1],u=r[o],h=r[o>r.length-2?r.length-1:o+1],c=r[o>r.length-3?r.length-1:o+2];return n.set(Io(a,l.x,u.x,h.x,c.x),Io(a,l.y,u.y,h.y,c.y)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new de().fromArray(r))}return this}}var Os=Object.freeze({__proto__:null,ArcCurve:mm,CatmullRomCurve3:gm,CubicBezierCurve:Ol,CubicBezierCurve3:bm,EllipseCurve:$s,LineCurve:Fl,LineCurve3:Tm,QuadraticBezierCurve:Bl,QuadraticBezierCurve3:Am,SplineCurve:zl});class wm extends Kt{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const n=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new Os[n](t,e))}return this}getPoint(e,t){const n=e*this.getLength(),r=this.getCurveLengths();let s=0;for(;s<r.length;){if(r[s]>=n){const o=r[s]-n,a=this.curves[s],l=a.getLength(),u=l===0?0:1-o/l;return a.getPointAt(u,t)}s++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let n=0,r=this.curves.length;n<r;n++)t+=this.curves[n].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let n;for(let r=0,s=this.curves;r<s.length;r++){const o=s[r],a=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,l=o.getPoints(a);for(let u=0;u<l.length;u++){const h=l[u];n&&n.equals(h)||(t.push(h),n=h)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(r.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,n=this.curves.length;t<n;t++){const r=this.curves[t];e.curves.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(new Os[r.type]().fromJSON(r))}return this}}class No extends wm{constructor(e){super(),this.type="Path",this.currentPoint=new de,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,n=e.length;t<n;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const n=new Fl(this.currentPoint.clone(),new de(e,t));return this.curves.push(n),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,n,r){const s=new Bl(this.currentPoint.clone(),new de(e,t),new de(n,r));return this.curves.push(s),this.currentPoint.set(n,r),this}bezierCurveTo(e,t,n,r,s,o){const a=new Ol(this.currentPoint.clone(),new de(e,t),new de(n,r),new de(s,o));return this.curves.push(a),this.currentPoint.set(s,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),n=new zl(t);return this.curves.push(n),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,n,r,s,o){const a=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+a,t+l,n,r,s,o),this}absarc(e,t,n,r,s,o){return this.absellipse(e,t,n,n,r,s,o),this}ellipse(e,t,n,r,s,o,a,l){const u=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(e+u,t+h,n,r,s,o,a,l),this}absellipse(e,t,n,r,s,o,a,l){const u=new $s(e,t,n,r,s,o,a,l);if(this.curves.length>0){const c=u.getPoint(0);c.equals(this.currentPoint)||this.lineTo(c.x,c.y)}this.curves.push(u);const h=u.getPoint(1);return this.currentPoint.copy(h),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class ki extends Lt{constructor(e=1,t=1,n=1,r=32,s=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:n,radialSegments:r,heightSegments:s,openEnded:o,thetaStart:a,thetaLength:l};const u=this;r=Math.floor(r),s=Math.floor(s);const h=[],c=[],p=[],m=[];let g=0;const _=[],f=n/2;let d=0;S(),o===!1&&(e>0&&x(!0),t>0&&x(!1)),this.setIndex(h),this.setAttribute("position",new dt(c,3)),this.setAttribute("normal",new dt(p,3)),this.setAttribute("uv",new dt(m,2));function S(){const v=new D,C=new D;let w=0;const A=(t-e)/n;for(let k=0;k<=s;k++){const y=[],T=k/s,O=T*(t-e)+e;for(let W=0;W<=r;W++){const Z=W/r,P=Z*l+a,F=Math.sin(P),z=Math.cos(P);C.x=O*F,C.y=-T*n+f,C.z=O*z,c.push(C.x,C.y,C.z),v.set(F,A,z).normalize(),p.push(v.x,v.y,v.z),m.push(Z,1-T),y.push(g++)}_.push(y)}for(let k=0;k<r;k++)for(let y=0;y<s;y++){const T=_[y][k],O=_[y+1][k],W=_[y+1][k+1],Z=_[y][k+1];h.push(T,O,Z),h.push(O,W,Z),w+=6}u.addGroup(d,w,0),d+=w}function x(v){const C=g,w=new de,A=new D;let k=0;const y=v===!0?e:t,T=v===!0?1:-1;for(let W=1;W<=r;W++)c.push(0,f*T,0),p.push(0,T,0),m.push(.5,.5),g++;const O=g;for(let W=0;W<=r;W++){const P=W/r*l+a,F=Math.cos(P),z=Math.sin(P);A.x=y*z,A.y=f*T,A.z=y*F,c.push(A.x,A.y,A.z),p.push(0,T,0),w.x=F*.5+.5,w.y=z*.5*T+.5,m.push(w.x,w.y),g++}for(let W=0;W<r;W++){const Z=C+W,P=O+W;v===!0?h.push(P,P+1,Z):h.push(P+1,P,Z),k+=3}u.addGroup(d,k,v===!0?1:2),d+=k}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ki(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Gl extends No{constructor(e){super(e),this.uuid=gi(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let n=0,r=this.holes.length;n<r;n++)t[n]=this.holes[n].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,n=this.holes.length;t<n;t++){const r=this.holes[t];e.holes.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(new No().fromJSON(r))}return this}}const Rm={triangulate:function(i,e,t=2){const n=e&&e.length,r=n?e[0]*t:i.length;let s=Hl(i,0,r,t,!0);const o=[];if(!s||s.next===s.prev)return o;let a,l,u,h,c,p,m;if(n&&(s=Um(i,e,s,t)),i.length>80*t){a=u=i[0],l=h=i[1];for(let g=t;g<r;g+=t)c=i[g],p=i[g+1],c<a&&(a=c),p<l&&(l=p),c>u&&(u=c),p>h&&(h=p);m=Math.max(u-a,h-l),m=m!==0?32767/m:0}return Fi(s,o,t,a,l,m,0),o}};function Hl(i,e,t,n,r){let s,o;if(r===Wm(i,e,t,n)>0)for(s=e;s<t;s+=n)o=Oo(s,i[s],i[s+1],o);else for(s=t-n;s>=e;s-=n)o=Oo(s,i[s],i[s+1],o);return o&&Nr(o,o.next)&&(zi(o),o=o.next),o}function Gn(i,e){if(!i)return i;e||(e=i);let t=i,n;do if(n=!1,!t.steiner&&(Nr(t,t.next)||Qe(t.prev,t,t.next)===0)){if(zi(t),t=e=t.prev,t===t.next)break;n=!0}else t=t.next;while(n||t!==e);return e}function Fi(i,e,t,n,r,s,o){if(!i)return;!o&&s&&Bm(i,n,r,s);let a=i,l,u;for(;i.prev!==i.next;){if(l=i.prev,u=i.next,s?Lm(i,n,r,s):Cm(i)){e.push(l.i/t|0),e.push(i.i/t|0),e.push(u.i/t|0),zi(i),i=u.next,a=u.next;continue}if(i=u,i===a){o?o===1?(i=Pm(Gn(i),e,t),Fi(i,e,t,n,r,s,2)):o===2&&Dm(i,e,t,n,r,s):Fi(Gn(i),e,t,n,r,s,1);break}}}function Cm(i){const e=i.prev,t=i,n=i.next;if(Qe(e,t,n)>=0)return!1;const r=e.x,s=t.x,o=n.x,a=e.y,l=t.y,u=n.y,h=r<s?r<o?r:o:s<o?s:o,c=a<l?a<u?a:u:l<u?l:u,p=r>s?r>o?r:o:s>o?s:o,m=a>l?a>u?a:u:l>u?l:u;let g=n.next;for(;g!==e;){if(g.x>=h&&g.x<=p&&g.y>=c&&g.y<=m&&oi(r,a,s,l,o,u,g.x,g.y)&&Qe(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function Lm(i,e,t,n){const r=i.prev,s=i,o=i.next;if(Qe(r,s,o)>=0)return!1;const a=r.x,l=s.x,u=o.x,h=r.y,c=s.y,p=o.y,m=a<l?a<u?a:u:l<u?l:u,g=h<c?h<p?h:p:c<p?c:p,_=a>l?a>u?a:u:l>u?l:u,f=h>c?h>p?h:p:c>p?c:p,d=Fs(m,g,e,t,n),S=Fs(_,f,e,t,n);let x=i.prevZ,v=i.nextZ;for(;x&&x.z>=d&&v&&v.z<=S;){if(x.x>=m&&x.x<=_&&x.y>=g&&x.y<=f&&x!==r&&x!==o&&oi(a,h,l,c,u,p,x.x,x.y)&&Qe(x.prev,x,x.next)>=0||(x=x.prevZ,v.x>=m&&v.x<=_&&v.y>=g&&v.y<=f&&v!==r&&v!==o&&oi(a,h,l,c,u,p,v.x,v.y)&&Qe(v.prev,v,v.next)>=0))return!1;v=v.nextZ}for(;x&&x.z>=d;){if(x.x>=m&&x.x<=_&&x.y>=g&&x.y<=f&&x!==r&&x!==o&&oi(a,h,l,c,u,p,x.x,x.y)&&Qe(x.prev,x,x.next)>=0)return!1;x=x.prevZ}for(;v&&v.z<=S;){if(v.x>=m&&v.x<=_&&v.y>=g&&v.y<=f&&v!==r&&v!==o&&oi(a,h,l,c,u,p,v.x,v.y)&&Qe(v.prev,v,v.next)>=0)return!1;v=v.nextZ}return!0}function Pm(i,e,t){let n=i;do{const r=n.prev,s=n.next.next;!Nr(r,s)&&Vl(r,n,n.next,s)&&Bi(r,s)&&Bi(s,r)&&(e.push(r.i/t|0),e.push(n.i/t|0),e.push(s.i/t|0),zi(n),zi(n.next),n=i=s),n=n.next}while(n!==i);return Gn(n)}function Dm(i,e,t,n,r,s){let o=i;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&Hm(o,a)){let l=kl(o,a);o=Gn(o,o.next),l=Gn(l,l.next),Fi(o,e,t,n,r,s,0),Fi(l,e,t,n,r,s,0);return}a=a.next}o=o.next}while(o!==i)}function Um(i,e,t,n){const r=[];let s,o,a,l,u;for(s=0,o=e.length;s<o;s++)a=e[s]*n,l=s<o-1?e[s+1]*n:i.length,u=Hl(i,a,l,n,!1),u===u.next&&(u.steiner=!0),r.push(Gm(u));for(r.sort(Im),s=0;s<r.length;s++)t=Nm(r[s],t);return t}function Im(i,e){return i.x-e.x}function Nm(i,e){const t=Om(i,e);if(!t)return e;const n=kl(t,i);return Gn(n,n.next),Gn(t,t.next)}function Om(i,e){let t=e,n=-1/0,r;const s=i.x,o=i.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const p=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(p<=s&&p>n&&(n=p,r=t.x<t.next.x?t:t.next,p===s))return r}t=t.next}while(t!==e);if(!r)return null;const a=r,l=r.x,u=r.y;let h=1/0,c;t=r;do s>=t.x&&t.x>=l&&s!==t.x&&oi(o<u?s:n,o,l,u,o<u?n:s,o,t.x,t.y)&&(c=Math.abs(o-t.y)/(s-t.x),Bi(t,i)&&(c<h||c===h&&(t.x>r.x||t.x===r.x&&Fm(r,t)))&&(r=t,h=c)),t=t.next;while(t!==a);return r}function Fm(i,e){return Qe(i.prev,i,e.prev)<0&&Qe(e.next,i,i.next)<0}function Bm(i,e,t,n){let r=i;do r.z===0&&(r.z=Fs(r.x,r.y,e,t,n)),r.prevZ=r.prev,r.nextZ=r.next,r=r.next;while(r!==i);r.prevZ.nextZ=null,r.prevZ=null,zm(r)}function zm(i){let e,t,n,r,s,o,a,l,u=1;do{for(t=i,i=null,s=null,o=0;t;){for(o++,n=t,a=0,e=0;e<u&&(a++,n=n.nextZ,!!n);e++);for(l=u;a>0||l>0&&n;)a!==0&&(l===0||!n||t.z<=n.z)?(r=t,t=t.nextZ,a--):(r=n,n=n.nextZ,l--),s?s.nextZ=r:i=r,r.prevZ=s,s=r;t=n}s.nextZ=null,u*=2}while(o>1);return i}function Fs(i,e,t,n,r){return i=(i-t)*r|0,e=(e-n)*r|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,i|e<<1}function Gm(i){let e=i,t=i;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==i);return t}function oi(i,e,t,n,r,s,o,a){return(r-o)*(e-a)>=(i-o)*(s-a)&&(i-o)*(n-a)>=(t-o)*(e-a)&&(t-o)*(s-a)>=(r-o)*(n-a)}function Hm(i,e){return i.next.i!==e.i&&i.prev.i!==e.i&&!Vm(i,e)&&(Bi(i,e)&&Bi(e,i)&&km(i,e)&&(Qe(i.prev,i,e.prev)||Qe(i,e.prev,e))||Nr(i,e)&&Qe(i.prev,i,i.next)>0&&Qe(e.prev,e,e.next)>0)}function Qe(i,e,t){return(e.y-i.y)*(t.x-e.x)-(e.x-i.x)*(t.y-e.y)}function Nr(i,e){return i.x===e.x&&i.y===e.y}function Vl(i,e,t,n){const r=xr(Qe(i,e,t)),s=xr(Qe(i,e,n)),o=xr(Qe(t,n,i)),a=xr(Qe(t,n,e));return!!(r!==s&&o!==a||r===0&&vr(i,t,e)||s===0&&vr(i,n,e)||o===0&&vr(t,i,n)||a===0&&vr(t,e,n))}function vr(i,e,t){return e.x<=Math.max(i.x,t.x)&&e.x>=Math.min(i.x,t.x)&&e.y<=Math.max(i.y,t.y)&&e.y>=Math.min(i.y,t.y)}function xr(i){return i>0?1:i<0?-1:0}function Vm(i,e){let t=i;do{if(t.i!==i.i&&t.next.i!==i.i&&t.i!==e.i&&t.next.i!==e.i&&Vl(t,t.next,i,e))return!0;t=t.next}while(t!==i);return!1}function Bi(i,e){return Qe(i.prev,i,i.next)<0?Qe(i,e,i.next)>=0&&Qe(i,i.prev,e)>=0:Qe(i,e,i.prev)<0||Qe(i,i.next,e)<0}function km(i,e){let t=i,n=!1;const r=(i.x+e.x)/2,s=(i.y+e.y)/2;do t.y>s!=t.next.y>s&&t.next.y!==t.y&&r<(t.next.x-t.x)*(s-t.y)/(t.next.y-t.y)+t.x&&(n=!n),t=t.next;while(t!==i);return n}function kl(i,e){const t=new Bs(i.i,i.x,i.y),n=new Bs(e.i,e.x,e.y),r=i.next,s=e.prev;return i.next=e,e.prev=i,t.next=r,r.prev=t,n.next=t,t.prev=n,s.next=n,n.prev=s,n}function Oo(i,e,t,n){const r=new Bs(i,e,t);return n?(r.next=n.next,r.prev=n,n.next.prev=r,n.next=r):(r.prev=r,r.next=r),r}function zi(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function Bs(i,e,t){this.i=i,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function Wm(i,e,t,n){let r=0;for(let s=e,o=t-n;s<t;s+=n)r+=(i[o]-i[s])*(i[s+1]+i[o+1]),o=s;return r}class Pi{static area(e){const t=e.length;let n=0;for(let r=t-1,s=0;s<t;r=s++)n+=e[r].x*e[s].y-e[s].x*e[r].y;return n*.5}static isClockWise(e){return Pi.area(e)<0}static triangulateShape(e,t){const n=[],r=[],s=[];Fo(e),Bo(n,e);let o=e.length;t.forEach(Fo);for(let l=0;l<t.length;l++)r.push(o),o+=t[l].length,Bo(n,t[l]);const a=Rm.triangulate(n,r);for(let l=0;l<a.length;l+=3)s.push(a.slice(l,l+3));return s}}function Fo(i){const e=i.length;e>2&&i[e-1].equals(i[0])&&i.pop()}function Bo(i,e){for(let t=0;t<e.length;t++)i.push(e[t].x),i.push(e[t].y)}class Qs extends Lt{constructor(e=new Gl([new de(.5,.5),new de(-.5,.5),new de(-.5,-.5),new de(.5,-.5)]),t={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:e,options:t},e=Array.isArray(e)?e:[e];const n=this,r=[],s=[];for(let a=0,l=e.length;a<l;a++){const u=e[a];o(u)}this.setAttribute("position",new dt(r,3)),this.setAttribute("uv",new dt(s,2)),this.computeVertexNormals();function o(a){const l=[],u=t.curveSegments!==void 0?t.curveSegments:12,h=t.steps!==void 0?t.steps:1,c=t.depth!==void 0?t.depth:1;let p=t.bevelEnabled!==void 0?t.bevelEnabled:!0,m=t.bevelThickness!==void 0?t.bevelThickness:.2,g=t.bevelSize!==void 0?t.bevelSize:m-.1,_=t.bevelOffset!==void 0?t.bevelOffset:0,f=t.bevelSegments!==void 0?t.bevelSegments:3;const d=t.extrudePath,S=t.UVGenerator!==void 0?t.UVGenerator:Xm;let x,v=!1,C,w,A,k;d&&(x=d.getSpacedPoints(h),v=!0,p=!1,C=d.computeFrenetFrames(h,!1),w=new D,A=new D,k=new D),p||(f=0,m=0,g=0,_=0);const y=a.extractPoints(u);let T=y.shape;const O=y.holes;if(!Pi.isClockWise(T)){T=T.reverse();for(let R=0,oe=O.length;R<oe;R++){const Y=O[R];Pi.isClockWise(Y)&&(O[R]=Y.reverse())}}const Z=Pi.triangulateShape(T,O),P=T;for(let R=0,oe=O.length;R<oe;R++){const Y=O[R];T=T.concat(Y)}function F(R,oe,Y){return oe||console.error("THREE.ExtrudeGeometry: vec does not exist"),R.clone().addScaledVector(oe,Y)}const z=T.length,q=Z.length;function K(R,oe,Y){let ae,J,be;const ge=R.x-oe.x,E=R.y-oe.y,M=Y.x-R.x,N=Y.y-R.y,ie=ge*ge+E*E,ee=ge*N-E*M;if(Math.abs(ee)>Number.EPSILON){const te=Math.sqrt(ie),ye=Math.sqrt(M*M+N*N),fe=oe.x-E/te,U=oe.y+ge/te,$=Y.x-N/ye,ce=Y.y+M/ye,H=(($-fe)*N-(ce-U)*M)/(ge*N-E*M);ae=fe+ge*H-R.x,J=U+E*H-R.y;const _e=ae*ae+J*J;if(_e<=2)return new de(ae,J);be=Math.sqrt(_e/2)}else{let te=!1;ge>Number.EPSILON?M>Number.EPSILON&&(te=!0):ge<-Number.EPSILON?M<-Number.EPSILON&&(te=!0):Math.sign(E)===Math.sign(N)&&(te=!0),te?(ae=-E,J=ge,be=Math.sqrt(ie)):(ae=ge,J=E,be=Math.sqrt(ie/2))}return new de(ae/be,J/be)}const j=[];for(let R=0,oe=P.length,Y=oe-1,ae=R+1;R<oe;R++,Y++,ae++)Y===oe&&(Y=0),ae===oe&&(ae=0),j[R]=K(P[R],P[Y],P[ae]);const Q=[];let re,se=j.concat();for(let R=0,oe=O.length;R<oe;R++){const Y=O[R];re=[];for(let ae=0,J=Y.length,be=J-1,ge=ae+1;ae<J;ae++,be++,ge++)be===J&&(be=0),ge===J&&(ge=0),re[ae]=K(Y[ae],Y[be],Y[ge]);Q.push(re),se=se.concat(re)}for(let R=0;R<f;R++){const oe=R/f,Y=m*Math.cos(oe*Math.PI/2),ae=g*Math.sin(oe*Math.PI/2)+_;for(let J=0,be=P.length;J<be;J++){const ge=F(P[J],j[J],ae);ve(ge.x,ge.y,-Y)}for(let J=0,be=O.length;J<be;J++){const ge=O[J];re=Q[J];for(let E=0,M=ge.length;E<M;E++){const N=F(ge[E],re[E],ae);ve(N.x,N.y,-Y)}}}const X=g+_;for(let R=0;R<z;R++){const oe=p?F(T[R],se[R],X):T[R];v?(A.copy(C.normals[0]).multiplyScalar(oe.x),w.copy(C.binormals[0]).multiplyScalar(oe.y),k.copy(x[0]).add(A).add(w),ve(k.x,k.y,k.z)):ve(oe.x,oe.y,0)}for(let R=1;R<=h;R++)for(let oe=0;oe<z;oe++){const Y=p?F(T[oe],se[oe],X):T[oe];v?(A.copy(C.normals[R]).multiplyScalar(Y.x),w.copy(C.binormals[R]).multiplyScalar(Y.y),k.copy(x[R]).add(A).add(w),ve(k.x,k.y,k.z)):ve(Y.x,Y.y,c/h*R)}for(let R=f-1;R>=0;R--){const oe=R/f,Y=m*Math.cos(oe*Math.PI/2),ae=g*Math.sin(oe*Math.PI/2)+_;for(let J=0,be=P.length;J<be;J++){const ge=F(P[J],j[J],ae);ve(ge.x,ge.y,c+Y)}for(let J=0,be=O.length;J<be;J++){const ge=O[J];re=Q[J];for(let E=0,M=ge.length;E<M;E++){const N=F(ge[E],re[E],ae);v?ve(N.x,N.y+x[h-1].y,x[h-1].x+Y):ve(N.x,N.y,c+Y)}}}ne(),le();function ne(){const R=r.length/3;if(p){let oe=0,Y=z*oe;for(let ae=0;ae<q;ae++){const J=Z[ae];Re(J[2]+Y,J[1]+Y,J[0]+Y)}oe=h+f*2,Y=z*oe;for(let ae=0;ae<q;ae++){const J=Z[ae];Re(J[0]+Y,J[1]+Y,J[2]+Y)}}else{for(let oe=0;oe<q;oe++){const Y=Z[oe];Re(Y[2],Y[1],Y[0])}for(let oe=0;oe<q;oe++){const Y=Z[oe];Re(Y[0]+z*h,Y[1]+z*h,Y[2]+z*h)}}n.addGroup(R,r.length/3-R,0)}function le(){const R=r.length/3;let oe=0;Se(P,oe),oe+=P.length;for(let Y=0,ae=O.length;Y<ae;Y++){const J=O[Y];Se(J,oe),oe+=J.length}n.addGroup(R,r.length/3-R,1)}function Se(R,oe){let Y=R.length;for(;--Y>=0;){const ae=Y;let J=Y-1;J<0&&(J=R.length-1);for(let be=0,ge=h+f*2;be<ge;be++){const E=z*be,M=z*(be+1),N=oe+ae+E,ie=oe+J+E,ee=oe+J+M,te=oe+ae+M;De(N,ie,ee,te)}}}function ve(R,oe,Y){l.push(R),l.push(oe),l.push(Y)}function Re(R,oe,Y){Ee(R),Ee(oe),Ee(Y);const ae=r.length/3,J=S.generateTopUV(n,r,ae-3,ae-2,ae-1);Ce(J[0]),Ce(J[1]),Ce(J[2])}function De(R,oe,Y,ae){Ee(R),Ee(oe),Ee(ae),Ee(oe),Ee(Y),Ee(ae);const J=r.length/3,be=S.generateSideWallUV(n,r,J-6,J-3,J-2,J-1);Ce(be[0]),Ce(be[1]),Ce(be[3]),Ce(be[1]),Ce(be[2]),Ce(be[3])}function Ee(R){r.push(l[R*3+0]),r.push(l[R*3+1]),r.push(l[R*3+2])}function Ce(R){s.push(R.x),s.push(R.y)}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes,n=this.parameters.options;return qm(t,n,e)}static fromJSON(e,t){const n=[];for(let s=0,o=e.shapes.length;s<o;s++){const a=t[e.shapes[s]];n.push(a)}const r=e.options.extrudePath;return r!==void 0&&(e.options.extrudePath=new Os[r.type]().fromJSON(r)),new Qs(n,e.options)}}const Xm={generateTopUV:function(i,e,t,n,r){const s=e[t*3],o=e[t*3+1],a=e[n*3],l=e[n*3+1],u=e[r*3],h=e[r*3+1];return[new de(s,o),new de(a,l),new de(u,h)]},generateSideWallUV:function(i,e,t,n,r,s){const o=e[t*3],a=e[t*3+1],l=e[t*3+2],u=e[n*3],h=e[n*3+1],c=e[n*3+2],p=e[r*3],m=e[r*3+1],g=e[r*3+2],_=e[s*3],f=e[s*3+1],d=e[s*3+2];return Math.abs(a-h)<Math.abs(o-u)?[new de(o,1-l),new de(u,1-c),new de(p,1-g),new de(_,1-d)]:[new de(a,1-l),new de(h,1-c),new de(m,1-g),new de(f,1-d)]}};function qm(i,e,t){if(t.shapes=[],Array.isArray(i))for(let n=0,r=i.length;n<r;n++){const s=i[n];t.shapes.push(s.uuid)}else t.shapes.push(i.uuid);return t.options=Object.assign({},e),e.extrudePath!==void 0&&(t.options.extrudePath=e.extrudePath.toJSON()),t}class ea extends Lt{constructor(e=.5,t=1,n=32,r=1,s=0,o=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:t,thetaSegments:n,phiSegments:r,thetaStart:s,thetaLength:o},n=Math.max(3,n),r=Math.max(1,r);const a=[],l=[],u=[],h=[];let c=e;const p=(t-e)/r,m=new D,g=new de;for(let _=0;_<=r;_++){for(let f=0;f<=n;f++){const d=s+f/n*o;m.x=c*Math.cos(d),m.y=c*Math.sin(d),l.push(m.x,m.y,m.z),u.push(0,0,1),g.x=(m.x/t+1)/2,g.y=(m.y/t+1)/2,h.push(g.x,g.y)}c+=p}for(let _=0;_<r;_++){const f=_*(n+1);for(let d=0;d<n;d++){const S=d+f,x=S,v=S+n+1,C=S+n+2,w=S+1;a.push(x,v,w),a.push(v,C,w)}}this.setIndex(a),this.setAttribute("position",new dt(l,3)),this.setAttribute("normal",new dt(u,3)),this.setAttribute("uv",new dt(h,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ea(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}class Hn extends Lt{constructor(e=1,t=32,n=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:n,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),n=Math.max(2,Math.floor(n));const l=Math.min(o+a,Math.PI);let u=0;const h=[],c=new D,p=new D,m=[],g=[],_=[],f=[];for(let d=0;d<=n;d++){const S=[],x=d/n;let v=0;d===0&&o===0?v=.5/t:d===n&&l===Math.PI&&(v=-.5/t);for(let C=0;C<=t;C++){const w=C/t;c.x=-e*Math.cos(r+w*s)*Math.sin(o+x*a),c.y=e*Math.cos(o+x*a),c.z=e*Math.sin(r+w*s)*Math.sin(o+x*a),g.push(c.x,c.y,c.z),p.copy(c).normalize(),_.push(p.x,p.y,p.z),f.push(w+v,1-x),S.push(u++)}h.push(S)}for(let d=0;d<n;d++)for(let S=0;S<t;S++){const x=h[d][S+1],v=h[d][S],C=h[d+1][S],w=h[d+1][S+1];(d!==0||o>0)&&m.push(x,v,w),(d!==n-1||l<Math.PI)&&m.push(v,C,w)}this.setIndex(m),this.setAttribute("position",new dt(g,3)),this.setAttribute("normal",new dt(_,3)),this.setAttribute("uv",new dt(f,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Hn(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Vn extends _i{constructor(e){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new We(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new We(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=fl,this.normalScale=new de(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.combine=Ws,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Or extends ft{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new We(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}class Ym extends Or{constructor(e,t,n){super(e,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(ft.DEFAULT_UP),this.updateMatrix(),this.groundColor=new We(t)}copy(e,t){return super.copy(e,t),this.groundColor.copy(e.groundColor),this}}const Ss=new nt,zo=new D,Go=new D;class Wl{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new de(512,512),this.map=null,this.mapPass=null,this.matrix=new nt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Ys,this._frameExtents=new de(1,1),this._viewportCount=1,this._viewports=[new $e(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,n=this.matrix;zo.setFromMatrixPosition(e.matrixWorld),t.position.copy(zo),Go.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Go),t.updateMatrixWorld(),Ss.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Ss),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(Ss)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Ho=new nt,Ti=new D,ys=new D;class Jm extends Wl{constructor(){super(new Ct(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new de(4,2),this._viewportCount=6,this._viewports=[new $e(2,1,1,1),new $e(0,1,1,1),new $e(3,1,1,1),new $e(1,1,1,1),new $e(3,0,1,1),new $e(1,0,1,1)],this._cubeDirections=[new D(1,0,0),new D(-1,0,0),new D(0,0,1),new D(0,0,-1),new D(0,1,0),new D(0,-1,0)],this._cubeUps=[new D(0,1,0),new D(0,1,0),new D(0,1,0),new D(0,1,0),new D(0,0,1),new D(0,0,-1)]}updateMatrices(e,t=0){const n=this.camera,r=this.matrix,s=e.distance||n.far;s!==n.far&&(n.far=s,n.updateProjectionMatrix()),Ti.setFromMatrixPosition(e.matrixWorld),n.position.copy(Ti),ys.copy(n.position),ys.add(this._cubeDirections[t]),n.up.copy(this._cubeUps[t]),n.lookAt(ys),n.updateMatrixWorld(),r.makeTranslation(-Ti.x,-Ti.y,-Ti.z),Ho.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Ho)}}class Km extends Or{constructor(e,t,n=0,r=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=r,this.shadow=new Jm}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class Zm extends Wl{constructor(){super(new wl(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class $m extends Or{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(ft.DEFAULT_UP),this.updateMatrix(),this.target=new ft,this.shadow=new Zm}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class jm extends Or{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ks}}));typeof window!="undefined"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ks);const Vo=.32,Qm=.62,eg=2.35,On=.3,ta=1.58,Cn=.26,xn=1.5,Xl=8.05,tg=5.55,ng=4.4,sn=.33,ig=-7.1,zs=100,ko=14,rt=12,rg=.0075,Wo=2.6,sg=.72,ag=[6211781,15909198,15242602,8302824,13213916],og=16718354,lg=6948352,ql=16774885,cg=12887412,Xo=1314332,Es=new Map;function Wi(i,e){const t=document.createElement("canvas");t.width=i,t.height=i,e(t.getContext("2d"),i);const n=new pm(t);return n.wrapS=Ii,n.wrapT=Ii,n.needsUpdate=!0,n}function ug(i){return`#${i.toString(16).padStart(6,"0")}`}function Rr(i,e){const t=`${i}:${e}`;if(Es.has(t))return Es.get(t);const n=hg(i,e);return Es.set(t,n),n}function hg(i,e){return i==="ball"?dg(e):i==="platform"?pg(e):i==="pole"?mg(e):i==="bomb"?fg():gg(e)}function fg(){return Wi(64,(i,e)=>{i.fillStyle="#1a1a22",i.fillRect(0,0,e,e),i.fillStyle="#3a3a48",i.beginPath(),i.arc(22,18,16,0,7),i.fill(),i.strokeStyle="#0c0c10",i.lineWidth=2,i.beginPath(),i.arc(32,32,22,.2,4),i.stroke(),i.fillStyle="#6a3118",i.fillRect(28,4,6,10),i.fillStyle="#ffb347",i.fillRect(30,0,3,5)})}function dg(i){return Wi(64,(e,t)=>{if(i==="pebble"){e.fillStyle="#b9b2a6",e.fillRect(0,0,t,t);for(let r=0;r<80;r++)e.fillStyle=r%2?"#8a8278":"#d4cdc4",e.beginPath(),e.arc(Math.random()*t,Math.random()*t,1+Math.random()*2.4,0,7),e.fill();return}if(i==="mint"){e.fillStyle="#8ff0c8",e.fillRect(0,0,t,t),e.fillStyle="#5bc9a4";for(let r=-t;r<t*2;r+=10)e.save(),e.translate(r,0),e.rotate(.5),e.fillRect(0,-t,5,t*3),e.restore();return}if(i==="gold"){const r=e.createLinearGradient(0,0,t,t);r.addColorStop(0,"#fff1a8"),r.addColorStop(.4,"#ffd24a"),r.addColorStop(.7,"#c4921a"),r.addColorStop(1,"#ffe58a"),e.fillStyle=r,e.fillRect(0,0,t,t),e.fillStyle="rgba(255,255,255,0.35)",e.fillRect(8,0,6,t),e.fillRect(28,0,3,t);return}if(i==="night"){e.fillStyle="#1c2258",e.fillRect(0,0,t,t),e.fillStyle="#5a6cff",e.fillRect(0,20,t,8),e.fillStyle="#fff6a8";for(let r=0;r<28;r++)e.fillRect(r*17%t,r*29%t,2,2);return}const n=e.createRadialGradient(22,18,4,32,32,36);n.addColorStop(0,"#ffffff"),n.addColorStop(.35,"#fff6e5"),n.addColorStop(1,"#e8c9a0"),e.fillStyle=n,e.fillRect(0,0,t,t)})}function pg(i){return Wi(64,(e,t)=>{if(i==="clay"){e.fillStyle="#c48a62",e.fillRect(0,0,t,t),e.strokeStyle="rgba(80,40,20,0.35)",e.lineWidth=1.2;for(let n=0;n<9;n++)e.beginPath(),e.moveTo(Math.random()*t,Math.random()*t),e.lineTo(Math.random()*t,Math.random()*t),e.stroke();return}if(i==="ice"){const n=e.createLinearGradient(0,0,t,t);n.addColorStop(0,"#e8f7ff"),n.addColorStop(1,"#7ec0ea"),e.fillStyle=n,e.fillRect(0,0,t,t),e.strokeStyle="rgba(255,255,255,0.7)",e.lineWidth=1;for(let r=0;r<12;r++)e.beginPath(),e.moveTo(r*7,0),e.lineTo(r*7+18,t),e.stroke();return}if(i==="candy"){e.fillStyle="#ff8ab8",e.fillRect(0,0,t,t);const n=["#ffc36b","#9dffc1","#c9a6ff","#ff9e7a"];for(let r=0;r<8;r++)e.fillStyle=n[r%n.length],e.fillRect(r*8,0,5,t);return}if(i==="ember"){e.fillStyle="#4a140c",e.fillRect(0,0,t,t),e.fillStyle="#ff6a3d";for(let n=0;n<18;n++)e.fillRect(n*11%t,n*19%t,3,8+n%5);e.fillStyle="#ffb347",e.fillRect(20,10,4,20),e.fillRect(40,28,3,16);return}e.fillStyle="#d8d0c4",e.fillRect(0,0,t,t),e.fillStyle="rgba(0,0,0,0.06)";for(let n=0;n<t;n+=4)e.fillRect(0,n,t,1)})}function mg(i){return Wi(64,(e,t)=>{if(i==="stone"){e.fillStyle="#8d8a86",e.fillRect(0,0,t,t),e.fillStyle="#6a6762";for(let n=0;n<50;n++)e.fillRect(n*13%t,n*23%t,3,2);return}if(i==="marble"){e.fillStyle="#eee8dc",e.fillRect(0,0,t,t),e.strokeStyle="rgba(80,70,60,0.4)",e.lineWidth=2,e.beginPath(),e.moveTo(0,10),e.quadraticCurveTo(40,30,64,18),e.moveTo(0,40),e.quadraticCurveTo(20,60,64,44),e.stroke();return}if(i==="neon"){e.fillStyle="#041614",e.fillRect(0,0,t,t),e.fillStyle="#4ef0d0",e.fillRect(0,8,t,6),e.fillRect(0,28,t,4),e.fillRect(0,48,t,6),e.fillStyle="#ffffff",e.fillRect(0,10,t,2);return}e.fillStyle="#c4a574",e.fillRect(0,0,t,t),e.strokeStyle="rgba(90,60,30,0.35)";for(let n=6;n<t;n+=10)e.beginPath(),e.moveTo(0,n),e.bezierCurveTo(20,n+3,40,n-3,64,n),e.stroke()})}function gg(i){return Wi(64,(e,t)=>{e.fillStyle=ug({dusk:1314332,mist:1844272,sky:1520202,void:460300}[i]||1314332),e.fillRect(0,0,t,t),e.fillStyle=i==="sky"?"rgba(180,220,255,0.35)":"rgba(255,246,200,0.55)";for(let n=0;n<(i==="void"?40:18);n++)e.fillRect(n*19%t,n*37%t,i==="void"?1:2,1)})}function Gs(i,e){return i==="ball"?e==="mint"?"repeating-linear-gradient(135deg,#8ff0c8 0 8px,#5bc9a4 8px 14px)":e==="gold"?"linear-gradient(135deg,#fff1a8,#ffd24a 40%,#c4921a 70%,#ffe58a)":e==="night"?"radial-gradient(circle at 30% 30%,#7a88ff,#1c2258 70%)":e==="pebble"?"radial-gradient(circle at 20% 20%,#d4cdc4,#8a8278)":"radial-gradient(circle at 30% 25%,#fff,#fff6e5 45%,#e8c9a0)":i==="platform"?e==="ice"?"linear-gradient(135deg,#e8f7ff,#7ec0ea)":e==="candy"?"repeating-linear-gradient(90deg,#ff8ab8 0 8px,#ffc36b 8px 16px,#9dffc1 16px 24px)":e==="ember"?"linear-gradient(180deg,#ffb347,#ff6a3d 40%,#4a140c)":e==="clay"?"linear-gradient(135deg,#d4a07a,#8c5a3a)":"linear-gradient(135deg,#5ec8c5,#f2c14e,#e8956a)":i==="pole"?e==="neon"?"repeating-linear-gradient(#041614 0 8px,#4ef0d0 8px 14px)":e==="marble"?"linear-gradient(135deg,#fff,#cfc6b8 50%,#eee8dc)":e==="stone"?"radial-gradient(circle at 40% 40%,#b0aca6,#6a6762)":"repeating-linear-gradient(#c4a574 0 10px,#a07d4e 10px 12px)":e==="sky"?"linear-gradient(#4a90c8,#17324a)":e==="void"?"radial-gradient(circle at 50% 20%,#2a2040,#07060c)":e==="mist"?"linear-gradient(#3a4a5c,#1c2430)":"linear-gradient(#3a2450,#140e1c)"}const qo=new Hn(Cn,16,12),Bt=new Vn({color:ql,emissive:9071168});function _g(i){const e=new at(qo,Bt);e.position.set(0,2.2,xn);const t=new Km(16761162,0,5);e.add(t);const n=[];for(let h=0;h<10;h++){const c=new Vn({color:16769162,emissive:16751146,transparent:!0,opacity:0,depthWrite:!1}),p=new at(qo,c);p.visible=!1,i.add(p),n.push(p)}let r=ql,s=9071168,o=0,a=0,l=0;function u(h){if(h<2&&l<=0){Bt.color.setHex(r),Bt.emissive.setHex(s),t.intensity=0;return}const c=Math.min(1,(h-1)/5),p=Math.max(c,l);Bt.color.setRGB(1,.92-c*.35,.55-c*.4),Bt.emissive.setRGB(.85+p*.15,.35+c*.25,.05),t.color.setRGB(1,.65-c*.2,.15),t.intensity=1.1+h*.55+l*2}return{mesh:e,vy:0,invuln:0,hopCd:0,vault:0,combo:0,reset(){e.position.set(0,2.2,xn),e.scale.set(1,1,1),this.vy=0,this.invuln=0,this.hopCd=0,this.vault=0,this.combo=0,l=0,n.forEach(h=>{h.visible=!1,h.material.opacity=0}),u(0)},setSkin(h){var c;r=h.color,s=(c=h.emissive)!=null?c:0,Bt.map=Rr("ball",h.id||"cream"),Bt.needsUpdate=!0,u(this.combo)},idle(h){e.rotation.y+=h*1.6;const c=performance.now()*.0022;e.position.y=2.2+Math.sin(c)*.16,e.scale.set(1+Math.sin(c*2)*.03,1-Math.sin(c*2)*.03,1+Math.sin(c*2)*.03),Bt.map&&(Bt.map.offset.x+=h*.12)},fall(h,c=0){this.combo=c,this.vy-=(Xl+c*1.9)*h;const p=ig-c*1.85;if(this.vy<p&&(this.vy=p),e.position.y+=this.vy*h,this.hopCd>0&&(this.hopCd-=h),this.vault>0&&(this.vault-=h),l>0&&(l=Math.max(0,l-h*4)),e.rotation.y+=h*(1.2+c*1.8),Bt.map&&(Bt.map.offset.x+=h*(.18+c*.12)),c>=2&&this.vy<0){const m=Math.min(1,c/5);e.scale.x+=(.72-m*.08-e.scale.x)*Math.min(1,h*12),e.scale.y+=(1.38+m*.22-e.scale.y)*Math.min(1,h*12),e.scale.z=e.scale.x}else e.scale.y+=(1-e.scale.y)*Math.min(1,h*10),e.scale.x+=(1-e.scale.x)*Math.min(1,h*10),e.scale.z=e.scale.x;if(u(c),o+=h,c>=2&&o>.028){o=0;const m=n[a%n.length];a+=1,m.visible=!0,m.position.copy(e.position),m.scale.set(e.scale.x*.92,e.scale.y*.92,e.scale.z*.92),m.material.opacity=.58}n.forEach(m=>{m.visible&&(m.material.opacity-=h*3.4,m.position.y+=h*.4,m.material.opacity<=0&&(m.visible=!1))})},bounce(h){e.position.y=h,this.vy=tg,e.scale.set(1.22,.68,1.22)},hop(h){return this.hopCd>0||this.vy>2.4||e.position.y>h?!1:(this.vy=ng,this.hopCd=.64,this.vault=.52,e.scale.set(.78,1.28,.78),!0)},burst(){l=1,e.scale.set(1.35,1.35,1.35)}}}const Yo=14,vg=280;function xg(i,{onRotate:e,onTap:t,onHop:n}){const r={left:!1,right:!1};let s=!1,o=0,a=0,l=0,u=0,h=0,c=null;function p(f){var d;f.button!=null&&f.button!==0||(s=!0,o=f.clientX,a=f.clientX,l=f.clientY,u=performance.now(),h=0,c=f.pointerId,(d=i.setPointerCapture)==null||d.call(i,f.pointerId))}function m(f){if(!s||c!=null&&f.pointerId!==c)return;const d=f.clientX-o;h+=Math.abs(d)+Math.abs(f.clientY-l),e(d*rg),o=f.clientX}function g(f){if(c!=null&&f.pointerId!==c)return;const d=performance.now()-u,S=Math.hypot(f.clientX-a,f.clientY-l);s=!1,c=null,S<Yo&&h<Yo&&d<vg&&(t==null||t())}function _(f,d){(f.code==="ArrowLeft"||f.code==="KeyA")&&(r.left=d),(f.code==="ArrowRight"||f.code==="KeyD")&&(r.right=d),(f.code==="ArrowLeft"||f.code==="ArrowRight"||f.code==="KeyA"||f.code==="KeyD")&&f.preventDefault(),d&&(f.code==="Space"||f.code==="KeyW")&&(f.preventDefault(),n==null||n())}return i.addEventListener("pointerdown",p),window.addEventListener("pointermove",m),window.addEventListener("pointerup",g),window.addEventListener("pointercancel",g),window.addEventListener("keydown",f=>_(f,!0)),window.addEventListener("keyup",f=>_(f,!1)),{step(f){r.left&&e(-Wo*f),r.right&&e(Wo*f)}}}const na={ball:[{id:"cream",ru:"Сливки",en:"Cream",color:16774885,emissive:9071168,price:0},{id:"pebble",ru:"Галька",en:"Pebble",color:12169894,emissive:3814444,price:0,chest:!0},{id:"mint",ru:"Мята",en:"Mint",color:9433288,emissive:1334336,price:120},{id:"gold",ru:"Золото",en:"Gold",color:16765514,emissive:6963968,price:260},{id:"night",ru:"Ночь",en:"Night",color:5926143,emissive:1581152,price:340}],platform:[{id:"original",ru:"Колодец",en:"Well",colors:[6211781,15909198,15242602,8302824,13213916],price:0},{id:"clay",ru:"Глина",en:"Clay",colors:[12880482,11039308,13934714,11828050,9198138],price:0,chest:!0},{id:"ice",ru:"Лёд",en:"Ice",colors:[10475519,8306922,13168895,6990040,11460607],price:140},{id:"candy",ru:"Конфета",en:"Candy",colors:[16747192,16761707,10354625,13215487,16752250],price:220},{id:"ember",ru:"Угли",en:"Ember",colors:[16738877,16757575,14240555,16747586,12073770],price:300}],pole:[{id:"wood",ru:"Дерево",en:"Wood",color:12887412,price:0},{id:"stone",ru:"Камень",en:"Stone",color:9276038,price:0,chest:!0},{id:"marble",ru:"Мрамор",en:"Marble",color:15261908,price:160},{id:"neon",ru:"Неон",en:"Neon",color:5173456,price:280}],bg:[{id:"dusk",ru:"Сумерки",en:"Dusk",color:1314332,fog:1314332,price:0},{id:"mist",ru:"Туман",en:"Mist",color:1844272,fog:1844272,price:0,chest:!0},{id:"sky",ru:"Небо",en:"Sky",color:1520202,fog:1718868,price:180},{id:"void",ru:"Бездна",en:"Void",color:460300,fog:723218,price:320}]},Mg=[{slot:"ball",id:"pebble"},{slot:"platform",id:"clay"},{slot:"pole",id:"stone"},{slot:"bg",id:"mist"}],Sg=[{id:"easy",floors:14,introRings:3,introGap:4,gapStart:4,gapMin:3,ramp:50,dangerStart:7,dangerMax:2,dangerEvery:12,secondGapAt:99},{id:"normal",floors:22,introRings:2,introGap:4,gapStart:3,gapMin:2,ramp:18,dangerStart:3,dangerMax:4,dangerEvery:4,secondGapAt:12,secondGapSize:2},{id:"hard",floors:32,introRings:1,introGap:3,gapStart:2,gapMin:2,ramp:8,dangerStart:2,dangerMax:6,dangerEvery:3,secondGapAt:6,secondGapSize:2}],pi={floors:0,introRings:2,introGap:4,gapStart:4,gapMin:2,ramp:36,dangerStart:6,dangerMax:4,dangerEvery:7,secondGapAt:99},yg={floors:0,introRings:2,introGap:4,gapStart:4,gapMin:2,ramp:40,dangerStart:14,dangerMax:2,dangerEvery:12,secondGapAt:99,bombs:!0,bombStart:2,bombMax:3,bombEvery:5};function nn(i,e){return na[i].find(t=>t.id===e)}function ia(i){const e=Math.sin(i*127.1+311.7)*43758.5453;return e-Math.floor(e)}function bs(i,e,t){for(let n=0;n<t;n++)i[(e+n)%rt]="gap"}function Eg(i,e,t,n,r){let s=0,o=0;for(;s<t&&o<48;){const a=Math.floor(ia(e*19+o+r)*rt);i[a]==="safe"&&(i[a]=n,s+=1),o+=1}}function Hs(i,e=pi){var p,m,g,_,f,d;const t=Array(rt).fill("safe"),n=e.floors||0;if(n&&i>=n)return t;const r=(p=e.introRings)!=null?p:2;if(i<r)return bs(t,i*3%rt,(m=e.introGap)!=null?m:4),t;const s=e.ramp||36,o=Math.min(1,(i-r)/s),a=(g=e.gapStart)!=null?g:4,l=(_=e.gapMin)!=null?_:2,u=Math.max(l,Math.round(a-o*(a-l))),h=Math.floor(ia(i+1)*rt);bs(t,h,u),i>=(e.secondGapAt||99)&&bs(t,(h+6)%rt,e.secondGapSize||2);const c=(f=e.dangerStart)!=null?f:8;if(i>=c){const S=Math.floor((i-c)/(e.dangerEvery||6)),x=Math.min((d=e.dangerMax)!=null?d:3,1+S);Eg(t,i,x,"danger",3)}return t.includes("gap")||(t[0]="gap"),t}function Jo(i,e){var o,a;if(!(e!=null&&e.bombs))return 0;const t=(o=e.bombStart)!=null?o:2;if(i<t)return 0;const n=ia(i*47.3+8.1),r=Math.min(1,(i-t)/16),s=(a=e.bombMax)!=null?a:3;return n<.12||n<.48-r*.1?1:n<.82?Math.min(s,2):Math.min(s,3)}const an=Math.PI*2/rt,bg=Cg(),Tg=new D,Ag=new ki(Vo,Vo,90,12),Xt=new Vn({color:cg}),qt=ag.map(i=>new Vn({color:i})),Vs=new Vn({color:og,emissive:lg}),Yl=new Vn({color:16777215,emissive:3805704,map:Rr("bomb","core")}),Jl=new Vn({color:3811864,emissive:2233352}),Cr=new Bn({color:16742930}),wg=new Hn(sn,14,12),Rg=new ki(.04,.055,.22,6),Ko=new Hn(.09,8,6),Zo=new Set([Vs,Yl,Jl,Cr,Xt,...qt]);let Ai=0;function Cg(){const i=Qm,e=eg,t=an*.48,n=new Gl,r=8;for(let o=0;o<=r;o++){const a=-t+2*t*o/r,l=Math.cos(a)*e,u=Math.sin(a)*e;o===0?n.moveTo(l,u):n.lineTo(l,u)}for(let o=r;o>=0;o--){const a=-t+2*t*o/r;n.lineTo(Math.cos(a)*i,Math.sin(a)*i)}const s=new Qs(n,{depth:On,bevelEnabled:!1});return s.rotateX(-Math.PI/2),s.translate(0,-On/2,0),s}function $o(i){return-i*ta}function Wt(i){const e=Math.sin(i*127.1)*43758.5453;return e-Math.floor(e)}function Lg(){const i=new Dn,e=new at(wg,Yl);i.add(e);const t=new at(Rg,Jl);t.position.y=sn+.08,i.add(t);const n=new at(Ko,Cr);n.position.y=sn+.22,i.add(n);const r=[0,1].map(()=>{const s=new at(Ko,Cr);return s.scale.setScalar(.42),i.add(s),s});return i.userData.body=e,i.userData.fuse=t,i.userData.spark=n,i.userData.embers=r,i}function Sr(i){const e=Math.PI*2;let t=i%e;return t<0&&(t+=e),Math.round(t/an)%rt}function jo(i,e){const t=Sr(e);for(let n=0;n<rt;n++){const r=(t+rt-n)%rt,s=(t+n)%rt;if(i[r]!=="gap")return r*an;if(i[s]!=="gap")return s*an}return e}function Ts(i,e,t=0,n=0){const r=On/2+sn+Math.abs(Math.sin(t*14+e*3))*.045+n;i.position.set(Math.cos(e)*xn,r,-Math.sin(e)*xn)}function Pg(i){const e=new Dn;i.add(e);const t=new at(Ag,Xt);i.add(t);const n=[];let r=c=>Hs(c,pi),s=c=>Jo(c,pi);function o(c,p){const m=new Dn;m.position.y=$o(c);const g=qt[c%qt.length];return p.forEach((_,f)=>{if(_==="gap")return;const d=new at(bg,_==="danger"?Vs:g);d.rotation.y=f*an,m.add(d)}),m}function a(c){const p=s(c.index),m=[];c.cells.forEach((d,S)=>{d!=="gap"&&m.push(S)});const g=[],_=m.slice(),f=Math.min(p,_.length);for(let d=0;d<f;d++){const S=Math.floor(Wt(c.index*13+d+2)*_.length),x=_.splice(S,1)[0],v=x*an,C=Wt(c.index*17+d*31+9),w=Wt(c.index*41+d*7+3),A=Wt(c.index*23+d*11+5),k=C>.5?1:-1,y=.45+w*2.35,T=A<.22?"dash":A<.48?"lunge":A<.72?"wander":"patrol";let O=m[Math.floor(Wt(c.index*53+d+4)*m.length)];O===x&&m.length>1&&(O=m[(m.indexOf(x)+3)%m.length]);const W=Lg();Ts(W,v),c.group.add(W),g.push({mesh:W,angle:v,speed:y*k,base:y,mood:T,turn:O*an,burst:0,dead:!1,wait:C*.7,timer:.35+w*1.1,lunge:0,hop:0,pulse:A*6})}c.rollers=g}function l(c){const p=r(c),m=o(c,p);e.add(m);const g={index:c,y:$o(c),cells:p,group:m,rollers:[],scored:!1,breaking:!1,shards:[],thump:0};a(g),n.push(g)}function u(c,p=[]){return c.isMesh&&p.push(c),c.children.forEach(m=>u(m,p)),p}function h(c){c.breaking||(c.breaking=!0,c.shards=u(c.group).map((p,m)=>{const g=p.material.clone();g.transparent=!0,g.depthWrite=!1,p.material=g;const _=Wt(c.index*17+m+1),f=Wt(c.index*31+m+5);return{mesh:p,vx:(_-.5)*2.6,vy:1.1+f*1.8,vz:(f-.5)*1.6,spinX:(_-.5)*9,spinZ:(f-.5)*11,life:.55+_*.35}}))}for(let c=0;c<ko;c++)l(c);return{root:e,rings:n,setGenerator(c,p){r=c,s=m=>Jo(m,p)},applyTheme({platformColors:c,poleColor:p,platformSkin:m,poleSkin:g}){const _=Rr("platform",m||"original");_.repeat.set(2,2),c&&c.forEach((f,d)=>{qt[d]&&(qt[d].color.setHex(f),qt[d].map=_,qt[d].emissive.setHex(m==="ember"?3803136:m==="ice"?532520:0),qt[d].needsUpdate=!0)}),p!=null&&Xt.color.setHex(p),Xt.map=Rr("pole",g||"wood"),Xt.map.repeat.set(1,10),Xt.emissive.setHex(g==="neon"?538672:0),Xt.needsUpdate=!0},rotate(c){e.rotation.y+=c},ballLocalAngle(c){const p=Tg.copy(c);e.updateMatrixWorld(),e.worldToLocal(p);let m=Math.atan2(-p.z,p.x);return m<0&&(m+=Math.PI*2),m},segmentIndex(c){const p=Math.PI*2;let m=c%p;return m<0&&(m+=p),Math.round(m/an)%rt},carveGap(c,p){const m=this.segmentIndex(p);[m,(m+1)%rt,(m+rt-1)%rt].forEach(f=>{c.cells[f]="gap"}),c.group.children.filter(f=>{if(!f.isMesh)return!1;const d=(f.rotation.y+Math.PI*2)%(Math.PI*2),S=Math.round(d/an)%rt;return c.cells[S]==="gap"}).forEach(f=>c.group.remove(f));for(const f of c.rollers)f.dead||c.cells[Sr(f.angle)]==="gap"&&(f.angle=jo(c.cells,f.angle),Ts(f.mesh,f.angle,Ai))},kindAt(c,p){if(c.breaking)return"gap";const m=this.segmentIndex(p),g=c.cells[m];if(g!=="gap")return g;const _=Math.PI*2/rt,f=Math.PI*2;let d=p%f;d<0&&(d+=f);const S=m*_;let x=d-S;if(x>Math.PI&&(x-=f),x<-Math.PI&&(x+=f),Math.abs(x)<_*.32)return"gap";const v=x>=0?(m+1)%rt:(m+rt-1)%rt,C=c.cells[v];return C==="gap"?"gap":C},hitRoller(c,p,m){const g=xn*.01;for(const _ of n){if(_.breaking)continue;const f=_.y+On/2+sn;if(!(Math.abs(c-f)>sn+.28))for(const d of _.rollers){if(d.dead||d.burst>0||m&&c>f-.02)continue;let S=p-d.angle;if(S>Math.PI&&(S-=Math.PI*2),S<-Math.PI&&(S+=Math.PI*2),Math.abs(S)*xn<sn+.22+g)return d}}return null},burstRoller(c){c.burst=.42},thumpRing(c){c.thump=1},shatterAbove(c){for(const p of n)p.breaking||!p.scored||p.y>c+ta*sg&&h(p)},update(c,p){Ai+=c;const m=.45+.55*Math.abs(Math.sin(Ai*10));Cr.color.setRGB(1,.28+m*.5,.04);const g=.28+.42*Math.abs(Math.sin(Ai*3.4));Vs.emissive.setRGB(g,.03,.01),Xt.map&&(Xt.map.offset.y+=c*(Xt.emissive.g>.1?.45:.08)),qt[0].map&&(qt[0].map.offset.x+=c*.05);for(const _ of n){if(_.thump>0){_.thump=Math.max(0,_.thump-c*5.5);const f=1+_.thump*.07;_.group.scale.set(f,1-_.thump*.1,f)}else _.group.scale.set(1,1,1);if(!_.breaking){for(const f of _.rollers){if(f.dead)continue;if(f.pulse+=c,f.burst>0){f.burst-=c;const A=.42-f.burst,k=A<.08?1-A*4:1+A*9;f.mesh.scale.setScalar(Math.max(.01,k));const y=f.mesh.userData.spark;y&&y.scale.setScalar(2+A*10),f.burst<=0&&(f.dead=!0,f.mesh.visible=!1);continue}if(f.timer-=c,f.hop>0&&(f.hop=Math.max(0,f.hop-c*3.2)),f.wait>0)f.wait-=c;else{let A=f.speed;if(f.mood==="dash")A=f.speed*(.35+1.85*Math.abs(Math.sin(f.pulse*2.1)));else if(f.mood==="lunge")f.timer<=0&&(f.lunge=.28+Wt(_.index+f.pulse)*.18,f.hop=.16,f.timer=.7+Wt(_.index*9+f.angle)*1.35),A=f.lunge>0?f.speed*2.7:f.speed*.22,f.lunge>0&&(f.lunge-=c);else if(f.mood==="wander")f.timer<=0&&(f.speed*=-1,f.hop=.08,f.timer=.4+Wt(f.pulse*17+_.index)*1.6);else if(f.mood==="patrol"){let y=f.angle-f.turn;y>Math.PI&&(y-=Math.PI*2),y<-Math.PI&&(y+=Math.PI*2),Math.abs(y)<.22&&f.timer<=0&&(f.speed*=-1,f.timer=.5)}const k=f.angle+A*c;_.cells[Sr(f.angle)]==="gap"?(f.angle=jo(_.cells,f.angle),f.speed*=-1):_.cells[Sr(k)]==="gap"?f.speed*=-1:f.angle=k}const d=Math.PI*2;f.angle=(f.angle%d+d)%d,Ts(f.mesh,f.angle,Ai,f.hop);const S=1+Math.abs(Math.sin(f.pulse*6))*.08;f.mesh.scale.set(S,1.05-(S-1),S);const x=f.mesh.userData.body;x&&(x.rotation.z-=f.speed*c*(xn/sn)*1.2,x.rotation.x=Math.sin(f.pulse*8)*.15);const v=f.mesh.userData.spark;v&&(v.scale.setScalar(.7+m*1.1),v.position.x=Math.sin(f.pulse*14)*.08,v.position.z=Math.cos(f.pulse*11)*.08);const C=f.mesh.userData.fuse;C&&(C.rotation.z=Math.sin(f.pulse*9)*.35);const w=f.mesh.userData.embers;w&&w.forEach((A,k)=>{const y=f.pulse*(9+k*4)+k;A.position.set(Math.sin(y)*.22,sn*.2+y%.35,Math.cos(y*1.3)*.22),A.scale.setScalar(.25+m*.4)})}continue}for(const f of _.shards){f.life-=c,f.vy-=Xl*1.6*c,f.mesh.position.x+=f.vx*c,f.mesh.position.y+=f.vy*c,f.mesh.position.z+=f.vz*c,f.mesh.rotation.x+=f.spinX*c,f.mesh.rotation.z+=f.spinZ*c;const d=Math.max(0,f.life/.7);f.mesh.scale.setScalar(.4+.6*d),f.mesh.material&&(f.mesh.material.opacity=d)}}for(;n.length&&n[0].breaking&&n[0].shards.every(_=>_.life<=0);){const _=n.shift();_.shards.forEach(f=>{f.mesh.material&&!Zo.has(f.mesh.material)&&f.mesh.material.dispose()}),e.remove(_.group),l(n[n.length-1].index+1)}t.position.y=p-20},reset(){var c;for(;n.length;){const p=n.shift();(c=p.shards)==null||c.forEach(m=>{m.mesh.material&&!Zo.has(m.mesh.material)&&m.mesh.material.dispose()}),e.remove(p.group)}e.rotation.y=0;for(let p=0;p<ko;p++)l(p);t.position.y=-20}}}const Dg=["ball","platform","pole","bg"];function Ug(i,{progress:e,locale:t,pack:n,onBuy:r,onEquip:s}){const o=e.data.equipped;i.innerHTML=Dg.map(a=>{const l=na[a].map(h=>{const c=e.owns(a,h.id),p=o[a]===h.id,m=h[t]||h.ru;let g="";return p?g=`<span class="tag">${n.equipped}</span>`:c?g=`<button class="btn mini" data-act="equip" data-slot="${a}" data-id="${h.id}">${n.owned}</button>`:h.chest?g=`<span class="tag dim">${n.fromChest}</span>`:g=`<button class="btn mini primary" data-act="buy" data-slot="${a}" data-id="${h.id}">${n.buy} · ${h.price}</button>`,`<div class="shop-item${p?" on":""}">
          <i class="swatch live" style="background:${Gs(a,h.id)}"></i>
          <div>
            <b>${m}</b>
            ${g}
          </div>
        </div>`}).join("");return`<section class="shop-slot"><h3>${a==="ball"?n.slotBall:a==="platform"?n.slotPlatform:a==="pole"?n.slotPole:n.slotBg}</h3>${l}</section>`}).join(""),i.querySelectorAll("[data-act]").forEach(a=>{a.addEventListener("click",()=>{const l=a.getAttribute("data-slot"),u=a.getAttribute("data-id");a.getAttribute("data-act")==="buy"?r(l,u):s(l,u)})})}const Qo=new Hn(.05,6,6),Ig=new Hn(.28,10,8),Ng=new ea(.18,.42,24),Og=new ki(.16,.16,.045,14),Fg=new Bn({color:16769126,transparent:!0,opacity:1});function el(i,e,t,n,r={}){const s=[];for(let o=0;o<t;o++){const a=new at(i,new Bn({color:e,transparent:!0,opacity:0,depthWrite:!1,...r}));a.visible=!1,n.add(a),s.push({mesh:a,vx:0,vy:0,vz:0,life:0,max:.4,spin:0})}return s}function Bg(i){const e=el(Qo,16770752,48,i),t=el(Qo,16738840,40,i),n=[];for(let S=0;S<20;S++){const x=new at(Og,Fg.clone());x.visible=!1,x.material.transparent=!0,x.rotation.x=Math.PI/2,i.add(x),n.push({mesh:x,vx:0,vy:0,vz:0,life:0,spin:0})}const r=new at(Ig,new Bn({color:16772744,transparent:!0,opacity:0,depthWrite:!1}));r.visible=!1,i.add(r);const s=r.clone();s.material=r.material.clone(),s.material.color.setHex(16726546),i.add(s);const o=new at(Ng,new Bn({color:16761162,transparent:!0,opacity:0,depthWrite:!1,side:Jt}));o.rotation.x=-Math.PI/2,o.visible=!1,i.add(o);const a=48,l=new Float32Array(a*3);for(let S=0;S<a;S++)l[S*3]=(Math.random()-.5)*22,l[S*3+1]=(Math.random()-.5)*28,l[S*3+2]=-6-Math.random()*16;const u=new Lt;u.setAttribute("position",new Vt(l,3));const h=new Nl({color:16773832,size:.08,transparent:!0,opacity:.55,depthWrite:!1}),c=new dm(u,h);i.add(c);let p=0,m=0,g=0,_=0,f=0;function d(S,x,v,C,w,A,k,y,T){let O=x;for(let W=0;W<k;W++){const Z=S[O%S.length];O+=1,Z.mesh.visible=!0,Z.mesh.position.set(v,C,w),Z.mesh.material.color.setHex(A),Z.mesh.material.opacity=.95,Z.vx=(Math.random()-.5)*y,Z.vy=.4+Math.random()*y,Z.vz=(Math.random()-.5)*y,Z.life=T*(.7+Math.random()*.5),Z.max=Z.life}return O}return{burst(S,x,v,C=16770752,w=8){m=d(e,m,S,x,v,C,w,2.4,.42)},explode(S,x,v){f=.55,r.visible=!0,r.position.set(S,x,v),r.scale.setScalar(.35),r.material.opacity=1,r.material.color.setHex(16774320),s.visible=!0,s.position.set(S,x,v),s.scale.setScalar(.2),s.material.opacity=.95,o.visible=!0,o.position.set(S,x,v),o.scale.setScalar(.3),o.material.opacity=.9,g=d(t,g,S,x,v,16751130,14,5.4,.55),g=d(t,g,S,x,v,16772710,10,6.2,.4),g=d(t,g,S,x,v,3809816,8,2.2,.7)},coins(S,x,v,C=3){for(let w=0;w<C;w++){const A=n[_%n.length];_+=1,A.mesh.visible=!0,A.mesh.position.set(S,x,v),A.mesh.scale.setScalar(1),A.vx=(Math.random()-.5)*1.8,A.vy=2.2+Math.random()*2.2,A.vz=(Math.random()-.5)*1.8,A.life=.95+Math.random()*.3,A.spin=10+Math.random()*12}},punch(S=.16){p=S},camKick(){const S=p;return p*=.84,p<.002&&(p=0),S},setStarColor(S){h.color.setHex(S)},update(S,x){c.position.y=x,c.rotation.y+=S*.04,h.opacity=.35+Math.abs(Math.sin(performance.now()*.0016))*.25,f>0&&(f-=S,r.scale.addScalar(S*9),r.material.opacity=Math.max(0,f*1.8),s.scale.addScalar(S*14),s.material.opacity=Math.max(0,f*1.4),o.scale.addScalar(S*11),o.material.opacity=Math.max(0,f*1.6),o.rotation.z+=S*4,f<=0&&(r.visible=!1,s.visible=!1,o.visible=!1));for(const v of e)v.mesh.visible&&(v.life-=S,v.vy-=6*S,v.mesh.position.x+=v.vx*S,v.mesh.position.y+=v.vy*S,v.mesh.position.z+=v.vz*S,v.mesh.material.opacity=Math.max(0,v.life*2.2),v.mesh.scale.setScalar(.6+v.life),v.life<=0&&(v.mesh.visible=!1));for(const v of t){if(!v.mesh.visible)continue;v.life-=S,v.vy-=8*S,v.mesh.position.x+=v.vx*S,v.mesh.position.y+=v.vy*S,v.mesh.position.z+=v.vz*S;const C=Math.max(0,v.life/(v.max||.4));v.mesh.material.opacity=C,v.mesh.scale.setScalar(.5+(1-C)*1.4),v.life<=0&&(v.mesh.visible=!1)}for(const v of n){if(!v.mesh.visible)continue;v.life-=S,v.vy-=7.2*S,v.mesh.position.x+=v.vx*S,v.mesh.position.y+=v.vy*S,v.mesh.position.z+=v.vz*S,v.mesh.rotation.y+=v.spin*S,v.mesh.rotation.z+=S*3;const C=Math.max(0,v.life);v.mesh.material.transparent=!0,v.mesh.material.opacity=Math.min(1,C*3),v.mesh.scale.setScalar(.7+C),v.life<=0&&(v.mesh.visible=!1)}}}}function zg(i){return i>0&&i<80?i*zs:i}function Gg(i,e,t,n){if(!i)return;const r=i.createOscillator(),s=i.createGain();r.frequency.value=e,r.type="sine",s.gain.value=n,r.connect(s),s.connect(i.destination),r.start(),s.gain.exponentialRampToValueAtTime(1e-4,i.currentTime+t),r.stop(i.currentTime+t)}function Hg(i){if(i==="fuse")return yg;const e=Sg.find(t=>t.id===i);return e||pi}function Vg(i,e,t,{progress:n,locale:r,pack:s}){var fe;const o=new fm;o.background=new We(Xo),o.fog=new Zs(Xo,14,34);const a=new Ct(55,1,.1,80),l=new Il({canvas:i,antialias:!1,alpha:!1,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!1});l.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5)),o.add(new jm(16777215,.35)),o.add(new Ym(16771272,4008778,.85));const u=new $m(16773852,.65);u.position.set(4,10,6),o.add(u);const h=Pg(o),c=_g(o),p=Bg(o);o.add(c.mesh);const m=new D;let g="menu",_="classic",f=0,d=zg(e.getBest());d!==e.getBest()&&e.setBest(d);let S=!0,x=!1,v=e.soundOn(),C=null,w=performance.now(),A=0,k=0,y=0,T=!1,O=!1,W=0,Z=2.2;function P(){g!=="play"||x||!O||c.hop(Z+ta*.85)&&(q(700,.07,.05),p.burst(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,16769162,10),p.punch(.08))}const F=xg(i,{onRotate(U){g!=="play"||x||h.rotate(U)},onTap:P,onHop:P});function z(){if(C)return;const U=window.AudioContext||window.webkitAudioContext;U&&(C=new U)}function q(U,$,ce){v&&(z(),(C==null?void 0:C.state)==="suspended"&&C.resume(),Gg(C,U,$,ce))}function K(U){v=U,e.setSoundOn(U),t.sound.classList.toggle("muted",!U),!U&&C&&C.suspend()}function j(){return _}function Q(){return n.data.best[j()]||0}function re(){n.recordScore(j(),f),_==="classic"&&f>d&&(d=f,e.setBest(d)),t.menuBest.textContent=String(Q()||d),t.deadBest.textContent=String(Q()||d)}function se(U){t.menu.classList.toggle("hidden",U!=="menu"),t.dead.classList.toggle("hidden",U!=="dead"),t.shop.classList.toggle("hidden",U!=="shop"),t.help.classList.toggle("hidden",U!=="help"),t.win.classList.toggle("hidden",U!=="win"),t.hud.classList.toggle("hidden",U!=="play")}let X=null;function ne(U){U&&(U.classList.remove("pop"),U.offsetWidth,U.classList.add("pop"))}function le(){const U=String(n.data.coins);t.menuCoins.textContent=U,t.shopCoins.textContent=U,t.hudCoins.textContent=U,X!==null&&X!==U&&(ne(t.menuCoins),ne(t.shopCoins),ne(t.hudCoins)),X=U}function Se(){const U=nn("ball",n.data.equipped.ball)||nn("ball","cream"),$=nn("platform",n.data.equipped.platform)||nn("platform","original"),ce=nn("pole",n.data.equipped.pole)||nn("pole","wood"),H=nn("bg",n.data.equipped.bg)||nn("bg","dusk");c.setSkin(U),h.applyTheme({platformColors:$.colors,poleColor:ce.color,platformSkin:$.id,poleSkin:ce.id}),o.background.setHex(H.color),o.fog.color.setHex(H.fog),p.setStarColor(H.id==="sky"?11065599:H.id==="void"?8939263:16773832),document.documentElement.style.setProperty("--bg",`#${H.color.toString(16).padStart(6,"0")}`)}function ve(){Ug(t.shopRoot,{progress:n,locale:r,pack:s,onBuy(U,$){n.buy(U,$)&&(Se(),le(),ve(),q(620,.08,.05))},onEquip(U,$){n.equip(U,$),Se(),ve(),q(480,.06,.04)}})}function Re(){var H,_e;const U=window.visualViewport,$=Math.max(1,Math.floor((H=U==null?void 0:U.width)!=null?H:window.innerWidth)),ce=Math.max(1,Math.floor((_e=U==null?void 0:U.height)!=null?_e:window.innerHeight));document.documentElement.style.setProperty("--app-h",`${ce}px`),l.setSize($,ce,!1),a.aspect=$/ce,a.updateProjectionMatrix()}function De(){const U=c.mesh.position.y,$=a.aspect<.86,ce=$?62:54;a.fov!==ce&&(a.fov=ce,a.updateProjectionMatrix());const H=p.camKick();$?(a.position.set(0,U+6.5+H,8.6+H*2),a.lookAt(0,U-1.35,0)):(a.position.set(0,U+5.8+H,7.2+H*2),a.lookAt(0,U-1.1,0))}function Ee(){A>=2?(t.combo.classList.remove("hidden"),t.combo.textContent=`x${A}`,t.combo.classList.remove("pulse"),t.combo.offsetWidth,t.combo.classList.add("pulse")):(t.combo.classList.add("hidden"),t.combo.classList.remove("pulse"))}function Ce(U){U&&(_=U);const $=Hg(_);O=_==="fuse",W=$.floors||0,T=!1,A=0,Z=2.2,k=0,y=0,h.setGenerator(ce=>Hs(ce,$),$),Se(),h.reset(),c.reset(),f=0,S=!0,t.score.textContent="0",t.continueBtn.classList.remove("hidden"),t.hopBtn.classList.toggle("hidden",!O),t.comboLayer&&t.comboLayer.replaceChildren(),Ee(),le(),g="play",x=!1,se("play"),e.startGameplay(),n.achieve("first_play",20),le(),q(520,.08,.05)}function R(U){const $=Math.floor(k/8),ce=Math.floor(f/200),H=U?25:0,_e=Math.max(1,y+$+ce+H);return n.addCoins(_e),f>=1e3&&n.achieve("score_1000",40),re(),le(),_e}function oe(){t.flash.classList.remove("hidden"),t.flash.classList.remove("boom"),t.flash.offsetWidth,t.flash.classList.add("boom"),window.setTimeout(()=>{t.flash.classList.add("hidden"),t.flash.classList.remove("boom")},360)}function Y(U=!1){if(g!=="play"||c.invuln>0)return;O&&!U&&oe(),p.punch(U?.5:.32),p.burst(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,16724760,U?6:12),e.stopGameplay();const $=R(!1),ce=()=>{g="dead",t.deadScore.textContent=String(f),t.deadBest.textContent=String(Q()||d),t.deadCoins.textContent=String($),t.continueBtn.classList.toggle("hidden",!S),se("dead"),q(140,.28,.08)};if(U){g="boom",q(80,.22,.12),window.setTimeout(ce,580);return}ce()}function ae(){const U=Mg.filter(ce=>!n.owns(ce.slot,ce.id));if(!U.length){const ce=18+Math.floor(Math.random()*18);return n.addCoins(ce),{type:"coins",amount:ce}}const $=U[Math.floor(Math.random()*U.length)];return n.grant($.slot,$.id),{type:"skin",...$}}function J(U){const $=t.chest,ce=t.chestFlies;if($&&($.classList.remove("open","shake"),$.offsetWidth,$.classList.add("shake"),window.setTimeout(()=>$.classList.add("open"),360)),ce){ce.replaceChildren();const H=U.type==="coins"?Math.min(16,7+Math.floor(U.amount/3)):12;for(let _e=0;_e<H;_e++){const Ae=document.createElement("i");Ae.className="fly-coin",Ae.style.setProperty("--dx",`${(Math.random()-.5)*170}px`),Ae.style.setProperty("--dy",`${-30-Math.random()*110}px`),Ae.style.animationDelay=`${.32+_e*.045}s`,ce.appendChild(Ae)}if(U.type==="skin"){const _e=document.createElement("i");_e.className="fly-skin",_e.style.background=Gs(U.slot,U.id),ce.appendChild(_e)}}if(t.chestLoot)if(t.chestLoot.replaceChildren(),U.type==="skin"){const H=nn(U.slot,U.id),_e=document.createElement("i");_e.className="swatch live prize-swatch",_e.style.background=Gs(U.slot,U.id);const Ae=document.createElement("b");Ae.textContent=(H==null?void 0:H[r])||U.id,t.chestLoot.append(_e,Ae)}else{const H=document.createElement("i");H.className="coin-icon";const _e=document.createElement("b");_e.textContent=`+${U.amount}`,t.chestLoot.append(H,_e)}}function be(){if(g!=="play")return;g="win",e.stopGameplay(),(_==="easy"||_==="normal"||_==="hard")&&(n.data.cleared[_]=!0,n.save(),_==="easy"&&n.achieve("beat_easy",50),_==="normal"&&n.achieve("beat_normal",80),_==="hard"&&n.achieve("beat_hard",120));const U=ae(),$=R(!0);p.punch(.22),p.burst(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,16770406,14),p.coins(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,8),t.winScore.textContent=String(f),t.winCoins.textContent=String($),J(U),le(),Se(),se("win"),q(880,.2,.06),window.setTimeout(()=>q(980,.12,.05),280),window.setTimeout(()=>q(1180,.16,.06),520)}function ge(){S=!1,c.invuln=.9,c.vy=0;const U=c.mesh.position.y,$=h.rings.find(ce=>Math.abs(ce.y-U)<1.4)||h.rings[0];$&&(h.carveGap($,h.ballLocalAngle(c.mesh.position)),c.bounce($.y+On/2+Cn+.12),Z=c.mesh.position.y,h.shatterAbove($.y)),g="play",se("play"),e.startGameplay()}function E(U){if(!t.comboLayer)return;m.copy(c.mesh.position).project(a);const $=(m.x*.5+.5)*i.clientWidth,ce=(-m.y*.5+.5)*i.clientHeight,H=document.createElement("div");H.className=U>=300?"combo-pop hot":"combo-pop",H.textContent=`+${U}`,H.style.left=`${$}px`,H.style.top=`${ce}px`,t.comboLayer.appendChild(H),window.setTimeout(()=>H.remove(),800)}function M(U,$){const ce=Math.atan2(Cn,xn);let H="gap";for(let _e=-2;_e<=2;_e++){const Ae=h.kindAt(U,$+ce*_e/2);if(Ae==="danger")return"danger";Ae==="safe"&&(H="safe")}return H}function N(){const U=c.mesh.position.y,$=h.ballLocalAngle(c.mesh.position),ce=U-Cn,H=U+Cn;if(O&&c.invuln<=0){const _e=h.hitRoller(U,$,c.vault>0);if(_e){_e.mesh.getWorldPosition(m),h.burstRoller(_e),p.explode(m.x,m.y,m.z),Y(!0);return}}for(const _e of h.rings){const Ae=_e.y+On/2,Ue=_e.y-On/2;if(!_e.scored&&H<Ue-.02&&(_e.scored=!0,A+=1,f+=zs*A,y+=A,t.score.textContent=String(f),t.score.classList.remove("pop"),t.score.offsetWidth,t.score.classList.add("pop"),Ee(),A>=2&&(c.burst(),E(zs*A),p.burst(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,16765514,10),p.punch(.1)),p.coins(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z,Math.min(6,A)),f>=1e3&&n.achieve("rings_run",15),A>=4&&n.achieve("combo_4",25),q(660+Math.min(8,A)*28,.07,.04),W&&_e.index+1>=W&&(T=!0)),!(ce<Ae&&H>Ue))continue;const Me=M(_e,$);if(Me==="gap")continue;if(U<_e.y){if(Me==="danger"){Y();return}c.mesh.position.y=Ue-Cn-.02,c.vy>0?c.vy=-Math.abs(c.vy)*.45:c.vy=Math.min(c.vy,-1.2),q(300,.05,.03);return}if(!(c.vy>.55&&ce>=Ae-.02)){if(Me==="danger"){Y();return}c.bounce(Ae+Cn),Z=c.mesh.position.y,A=0,Ee(),h.thumpRing(_e),h.shatterAbove(_e.y),p.burst(c.mesh.position.x,c.mesh.position.y,c.mesh.position.z),p.punch(.14),q(420,.06,.035),T&&be();return}}}function ie(U){const $=Math.min(.033,(U-w)/1e3);w=U,g==="play"&&!x?(k+=$,Math.floor(k/10)>Math.floor((k-$)/10)&&(n.addCoins(1),le()),F.step($),c.invuln>0&&(c.invuln-=$),c.fall($,Math.max(0,A-1)),N(),h.update($,c.mesh.position.y),p.update($,c.mesh.position.y),De()):(g==="menu"||g==="shop"||g==="help"?(h.rotate($*.25),c.idle($)):g!=="boom"&&h.rotate($*.08),h.update($,c.mesh.position.y),p.update($,c.mesh.position.y),De()),l.render(o,a),requestAnimationFrame(ie)}function ee(){x=!0,e.stopGameplay(),C&&v&&C.suspend()}function te(){document.hidden||(x=!1,w=performance.now(),g==="play"&&e.startGameplay(),C&&v&&C.resume())}function ye(){g="menu",se("menu"),c.reset(),h.setGenerator(U=>Hs(U,pi),pi),Se(),h.reset(),t.hopBtn.classList.add("hidden"),t.menuBest.textContent=String(n.data.best.classic||d),le(),De()}return t.classic.addEventListener("click",()=>{z(),Ce("classic")}),t.easy.addEventListener("click",()=>{z(),Ce("easy")}),t.normal.addEventListener("click",()=>{z(),Ce("normal")}),t.hard.addEventListener("click",()=>{z(),Ce("hard")}),t.fuse.addEventListener("click",()=>{z(),Ce("fuse")}),t.shopBtn.addEventListener("click",()=>{ve(),le(),g="shop",se("shop")}),t.shopBack.addEventListener("click",ye),t.helpBtn.addEventListener("click",()=>{g="help",se("help")}),t.helpBack.addEventListener("click",ye),t.winMenu.addEventListener("click",ye),t.again.addEventListener("click",async()=>{ee(),await e.showFullscreen(),Ce(_)}),t.continueBtn.addEventListener("click",async()=>{if(ee(),!await e.showRewarded()){t.continueBtn.classList.add("hidden"),te();return}ge(),x=!1}),t.menuBtn.addEventListener("click",async()=>{ee(),await e.showFullscreen(),ye()}),t.hopBtn.addEventListener("click",U=>{U.stopPropagation(),P()}),t.sound.addEventListener("click",()=>{z(),K(!v),v&&q(500,.06,.05)}),document.addEventListener("visibilitychange",()=>{document.hidden?ee():te()}),e.onPause(ee),e.onResume(te),window.addEventListener("resize",Re),(fe=window.visualViewport)==null||fe.addEventListener("resize",Re),t.menuBest.textContent=String(n.data.best.classic||d),t.deadBest.textContent=String(d),K(v),t.sound.classList.remove("hidden"),Se(),le(),ve(),Re(),De(),requestAnimationFrame(ie),{renderer:l,markReady(){return e.ready()}}}const Di="kolodets_best",Ui="kolodets_sound";function Kl(){return Number(localStorage.getItem(Di))||0}function Zl(){return localStorage.getItem(Ui)!=="0"}function kg(){let i=!1;return{isMock:!0,localeLang:"ru",async ready(){},startGameplay(){i=!0},stopGameplay(){i=!1},isGameplay(){return i},getBest(){return Kl()},setBest(e){localStorage.setItem(Di,String(e))},soundOn(){return Zl()},setSoundOn(e){localStorage.setItem(Ui,e?"1":"0")},showFullscreen(){return Promise.resolve(!1)},showRewarded(){return Promise.resolve(!0)},onPause(){},onResume(){},getJSON(e,t){try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch{return t}},setJSON(e,t){localStorage.setItem(e,JSON.stringify(t))}}}function Wg(i){var s,o;let e=!1,t=null;function n(){var a,l;e||(e=!0,(l=(a=i.features)==null?void 0:a.GameplayAPI)==null||l.start())}function r(){var a,l;e&&(e=!1,(l=(a=i.features)==null?void 0:a.GameplayAPI)==null||l.stop())}return{isMock:!1,localeLang:((o=(s=i.environment)==null?void 0:s.i18n)==null?void 0:o.lang)||"ru",async ready(){var a,l,u;t=await((a=i.getStorage)==null?void 0:a.call(i).catch(()=>null)),(u=(l=i.features)==null?void 0:l.LoadingAPI)==null||u.ready()},startGameplay:n,stopGameplay:r,isGameplay(){return e},getBest(){var u;const a=Number((u=t==null?void 0:t.getItem)==null?void 0:u.call(t,Di)),l=Kl();return a>l?a:l},setBest(a){var l;localStorage.setItem(Di,String(a)),(l=t==null?void 0:t.setItem)==null||l.call(t,Di,String(a))},soundOn(){if(t){const a=t.getItem(Ui);if(a!=null)return a!=="0"}return Zl()},setSoundOn(a){var u;const l=a?"1":"0";localStorage.setItem(Ui,l),(u=t==null?void 0:t.setItem)==null||u.call(t,Ui,l)},showFullscreen(){return new Promise(a=>{var l;if(!((l=i.adv)!=null&&l.showFullscreenAdv)){a(!1);return}r(),i.adv.showFullscreenAdv({callbacks:{onClose(u){a(!!u)},onError(){a(!1)}}})})},showRewarded(){return new Promise(a=>{var u;if(!((u=i.adv)!=null&&u.showRewardedVideo)){a(!1);return}let l=!1;r(),i.adv.showRewardedVideo({callbacks:{onRewarded(){l=!0},onClose(){a(l)},onError(){a(!1)}}})})},onPause(a){var l;(l=i.on)==null||l.call(i,"game_api_pause",a)},onResume(a){var l;(l=i.on)==null||l.call(i,"game_api_resume",a)},getJSON(a,l){var u;try{const c=((u=t==null?void 0:t.getItem)==null?void 0:u.call(t,a))||localStorage.getItem(a);return c?JSON.parse(c):l}catch{return l}},setJSON(a,l){var h;const u=JSON.stringify(l);localStorage.setItem(a,u),(h=t==null?void 0:t.setItem)==null||h.call(t,a,u)}}}async function Xg(){const i=window.YaGames;if(!i)return kg();const e=await i.init();return Wg(e)}const tl="kolodets_progress_v2";function wi(){return{coins:40,owned:{ball:["cream"],platform:["original"],pole:["wood"],bg:["dusk"]},equipped:{ball:"cream",platform:"original",pole:"wood",bg:"dusk"},best:{classic:0,fuse:0,easy:0,normal:0,hard:0},cleared:{easy:!1,normal:!1,hard:!1},fuseUnlocked:!1,achievements:{}}}function qg(i){const e=Object.assign(wi(),i.getJSON(tl,{}));e.owned||(e.owned=wi().owned),e.equipped||(e.equipped=wi().equipped),e.best||(e.best=wi().best),e.cleared||(e.cleared=wi().cleared),e.achievements||(e.achievements={});function t(){i.setJSON(tl,e)}function n(h,c){return e.owned[h].includes(c)}function r(h){return h<=0?0:(e.coins+=h,t(),h)}function s(h,c){return n(h,c)?!1:(e.owned[h].push(c),t(),!0)}function o(h,c){const p=na[h].find(m=>m.id===c);return!p||p.chest||n(h,c)||e.coins<p.price?!1:(e.coins-=p.price,e.owned[h].push(c),e.equipped[h]=c,t(),!0)}function a(h,c){return n(h,c)?(e.equipped[h]=c,t(),!0):!1}function l(h,c){return c>(e.best[h]||0)?(e.best[h]=c,t(),!0):!1}function u(h,c){return e.achievements[h]?0:(e.achievements[h]=!0,r(c))}return t(),{data:e,save:t,owns:n,addCoins:r,grant:s,buy:o,equip:a,recordScore:l,achieve:u}}function Yg(){const i=e=>e.preventDefault();document.addEventListener("contextmenu",i),document.addEventListener("selectstart",i),document.addEventListener("touchmove",e=>{e.touches.length>1&&e.preventDefault()},{passive:!1}),document.addEventListener("gesturestart",i),window.addEventListener("touchmove",e=>{var t,n;(n=(t=e.target)==null?void 0:t.closest)!=null&&n.call(t,".panel.scroll")||e.preventDefault()},{passive:!1})}function Jg(){return{menu:document.getElementById("screen-menu"),dead:document.getElementById("screen-dead"),shop:document.getElementById("screen-shop"),help:document.getElementById("screen-help"),win:document.getElementById("screen-win"),hud:document.getElementById("hud"),score:document.getElementById("hud-score"),combo:document.getElementById("hud-combo"),hudCoins:document.getElementById("hud-coins"),chest:document.getElementById("chest"),chestFlies:document.getElementById("chest-flies"),menuCoins:document.getElementById("menu-coins"),shopCoins:document.getElementById("shop-coins"),menuBest:document.getElementById("menu-best"),deadScore:document.getElementById("dead-score"),deadBest:document.getElementById("dead-best"),deadCoins:document.getElementById("dead-coins"),winScore:document.getElementById("win-score"),winCoins:document.getElementById("win-coins"),chestLoot:document.getElementById("chest-loot"),classic:document.getElementById("btn-classic"),easy:document.getElementById("btn-easy"),normal:document.getElementById("btn-normal"),hard:document.getElementById("btn-hard"),fuse:document.getElementById("btn-fuse"),shopBtn:document.getElementById("btn-shop"),shopBack:document.getElementById("btn-shop-back"),shopRoot:document.getElementById("shop-root"),helpBtn:document.getElementById("btn-help"),helpBack:document.getElementById("btn-help-back"),winMenu:document.getElementById("btn-win-menu"),again:document.getElementById("btn-again"),continueBtn:document.getElementById("btn-continue"),menuBtn:document.getElementById("btn-menu"),hopBtn:document.getElementById("btn-hop"),comboLayer:document.getElementById("combo-layer"),sound:document.getElementById("btn-sound"),flash:document.getElementById("flash")}}async function Kg(){Yg();const i=await Xg(),e=ic(i.localeLang),t=rc(e),n=qg(i),r=Vg(document.getElementById("game-canvas"),i,Jg(),{progress:n,locale:e,pack:t});await new Promise(s=>requestAnimationFrame(s)),await r.markReady()}Kg();
